...
Note: The license mentioned is applicable to code only; texture and model assets belong to their respective authors under All Rights Reserved and require express permission from said authors for use and redistribution. This is not in effect if you are redistributing the project as a whole, i.e. including it in modpacks.
