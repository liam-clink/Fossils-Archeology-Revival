...
public class ModelFireDragon extends MowzieModelBase {
	...
	public ModelFireDragon() {
		...
		this.setRotateAngle(ClawR, -3.089232776029963F, 0.7155849933176751F, -2.5497515042385164F);
		...
		this.setRotateAngle(ClawL, 3.089232776029963F, -0.7155849933176751F, -2.548180707911721F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		/*}else*/ if(dragon.getSleeping() == 0){
			...
			this.walk(ThighL, speed, 0.8F, false, 0F, 0.4F, entity.ticksExisted, 1);
			this.walk(LegL, speed, 0.2F, false, 0F, -0.6F, entity.ticksExisted, 1);
			this.walk(ToeL1, speed, -0.4F, false, 4.5F, 0.4F, entity.ticksExisted, 1);
			this.walk(ToeL2, speed, -0.4F, false, 4.5F, 0.4F, entity.ticksExisted, 1);
			this.walk(ToeL3, speed, -0.4F, false, 4.5F, 0.4F, entity.ticksExisted, 1);

			this.walk(ThighR, speed, 0.8F, true, 0F, 0.4F, entity.ticksExisted, 1);
			this.walk(LegR, speed, 0.2F, true, 0F, -0.6F, entity.ticksExisted, 1);
			this.walk(ToeR1, speed, -0.4F, true, 4.5F, 0.4F, entity.ticksExisted, 1);
			this.walk(ToeR2, speed, -0.4F, true, 4.5F, 0.4F, entity.ticksExisted, 1);
			this.walk(ToeR3, speed, -0.4F, true, 4.5F, 0.4F, entity.ticksExisted, 1);
		...
		//	this.walk(LeftAnkle, 0.5F * scaleFactor, 0.5F, false, 0F, 0F, f, f1);
			...
			this.chainWave(neckParts, speed, 0.07F, 4, entity.ticksExisted, 1);
