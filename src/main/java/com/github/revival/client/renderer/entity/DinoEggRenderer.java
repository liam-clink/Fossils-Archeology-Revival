...
import com.github.revival.client.model.DinoEggModel;
...
public class DinoEggRenderer extends Render {
    protected DinoEggModel MainModel;

    public DinoEggRenderer(float var1) {
        this.shadowSize = var1;
        this.MainModel = new DinoEggModel();
    }

    public void renderDinoEgg(DinoEggEntity var1, double var2, double var4, double var6, float var8, float var9) {
    ...
    public void doRenderLiving(DinoEggEntity var1, double var2, double var4, double var6, float var8, float var9) {
    ...
    public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
        this.renderDinoEgg((DinoEggEntity) var1, var2, var4, var6, var8, var9);
    }
