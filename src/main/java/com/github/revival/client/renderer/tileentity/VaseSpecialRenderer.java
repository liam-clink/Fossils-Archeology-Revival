...
public class VaseSpecialRenderer extends TileEntitySpecialRenderer {
    // volute textures
    ...
    public final VaseVoluteModel modelVolute;
    public final VaseAmphoraModel modelAmphora;
    public final VaseKylixModel modelKylix;
    private ModelBase proxyVase;

    // also gets model of our block
    public VaseSpecialRenderer() {
        this.modelVolute = new VaseVoluteModel();
        this.modelAmphora = new VaseAmphoraModel();
        this.modelKylix = new VaseKylixModel();
    }

    // renders entity in world
    public void renderTileEntityFigurineAt(VaseTile te, double x, double y, double z, float scale) {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double d0, double d1,
                                   double d2, float f) {
        this.renderTileEntityFigurineAt((VaseTile) tileentity, d0, d1, d2, f);
    }
}
