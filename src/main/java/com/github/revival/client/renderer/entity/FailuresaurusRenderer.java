...
public class FailuresaurusRenderer extends RenderLiving {
    ...
    public FailuresaurusRenderer(ModelBase var1, float var2) {
        super(var1, var2);
    }

    protected ResourceLocation getResourceLocation(FailuresaurusEntity entity) {
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        return this.getResourceLocation((FailuresaurusEntity) entity);
    }
}
