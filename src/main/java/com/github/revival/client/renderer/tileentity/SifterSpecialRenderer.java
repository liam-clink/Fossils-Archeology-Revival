...
public class SifterSpecialRenderer extends TileEntitySpecialRenderer {
    ...
    private final SifterModel modelSifter = new SifterModel();
    private float yRotationAngle;
    private float speed;
    private double theta;
    private double angle;

    public SifterSpecialRenderer() {
        yRotationAngle = 0.10F;
        speed = 0.10F;
    }

    public void renderTileEntityAt(SifterTile tileentity, double x, double y, double z, float partialTickTime) {
        GL11.glPushMatrix();
    ...
    public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
        this.renderTileEntityAt((SifterTile) par1TileEntity, par2, par4, par6, par8);
    }
