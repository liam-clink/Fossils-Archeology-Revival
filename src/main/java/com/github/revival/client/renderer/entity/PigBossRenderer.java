...
public class PigBossRenderer extends RenderLiving {

    public PigBossRenderer(PigBossModel var1, float var2) {
        super(var1, var2);
        this.setRenderPassModel(var1);

    }

    protected ResourceLocation func_110919_a(AnuEntity par1Entity) {
        return new ResourceLocation("fossil:textures/model/PigBoss.png");
    }

    protected ResourceLocation getEntityTexture(Entity par1Entity) {
        return this.func_110919_a((AnuEntity) par1Entity);
    }

    protected void preRenderScale(AnuEntity mob, float par2) {
    ...
    protected int shouldRenderPass(EntityLivingBase entity, int i, float q) {
        if (((AnuEntity) entity).getAttackMode() == 2) {
    ...
    protected void preRenderCallback(EntityLivingBase par1EntityLivingBase, float par2) {
        this.preRenderScale((AnuEntity) par1EntityLivingBase, par2);
    }
    ...
    protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
        ...
        if (itemstack1 != null) {
            GL11.glPushMatrix();
            ((PigBossModel) this.mainModel).Head.postRender(0.0625F);
        ...
        if (itemstack != null && itemstack.getItem() != null) {
            ...
            ((PigBossModel) this.mainModel).rightArm.postRender(0.0625F);
    ...
    public void doRender(EntityLiving var1, double var2, double var4, double var6, float var8, float var9) {
        BossStatus.setBossStatus((AnuEntity) var1, true);
