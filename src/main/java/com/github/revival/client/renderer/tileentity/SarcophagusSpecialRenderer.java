...
import com.github.revival.client.model.SarcophagusModel;
import com.github.revival.server.block.entity.SarcophagusTile;
...
public class SarcophagusSpecialRenderer extends TileEntitySpecialRenderer {
    ...
    EntityItem key = new EntityItem(Minecraft.getMinecraft().theWorld, 0D, 0D, 0D, new ItemStack(FAItemRegistry.gem));
    private SarcophagusModel model = new SarcophagusModel();
    private PigBossModel model_anu = new PigBossModel();

    public void renderTileEntityAt(SarcophagusTile chest, double x, double y, double z, float i1) {
        int i = 0;
    ...
    public void renderTileEntityAt(TileEntity chest, double x, double y, double z, float i1) {
        this.renderTileEntityAt((SarcophagusTile) chest, x, y, z, i1);
    }
}