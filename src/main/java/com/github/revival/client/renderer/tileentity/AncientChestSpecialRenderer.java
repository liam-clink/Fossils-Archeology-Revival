...
public class AncientChestSpecialRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(AncientChestTile chest, double x, double y, double z, float i1) {
        int i = 0;
    ...
    public void renderTileEntityAt(TileEntity chest, double x, double y, double z, float i1) {
        this.renderTileEntityAt((AncientChestTile) chest, x, y, z, i1);
    }
}