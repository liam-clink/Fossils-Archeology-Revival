...
public class FigurineSpecialRenderer extends TileEntitySpecialRenderer {
    ...
    public final FigurineModel model;
    public final FigurineBrokenModel modelbroken;

    // also gets model of our block
    public FigurineSpecialRenderer() {
        this.model = new FigurineModel();
        this.modelbroken = new FigurineBrokenModel();
    }

    // renders entity in world
    public void renderTileEntityFigurineAt(FigurineTile te, double x, double y, double z, float scale) {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double d0, double d1,
                                   double d2, float f) {
        this.renderTileEntityFigurineAt((FigurineTile) tileentity, d0, d1, d2, f);
    }
}
