...
public class SentryPigmanRenderer extends RenderBiped {
     ...
     */
    protected ResourceLocation getEntityTexture(SentryPigmanEntity mob) {
    ...
    protected ResourceLocation getEntityTexture(EntityLiving mob) {
        return this.getEntityTexture((SentryPigmanEntity) mob);
    }
