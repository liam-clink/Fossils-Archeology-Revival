...
public class TerrorBirdRenderer extends RenderLiving {
    ...
    public TerrorBirdRenderer(ModelBase par1ModelBase, float par2) {
        super(par1ModelBase, par2);
    }

    public void renderDodo(TerrorBirdEntity entity, double par2, double par4, double par6, float par8, float par9) {
     ...
     */
    protected float handleRotationFloat(TerrorBirdEntity entity, float angle) {
        if (entity.isAngry()) {
    ...
    protected float handleRotationFloat(EntityLivingBase entityLivingBase, float angle) {
        return this.handleRotationFloat((TerrorBirdEntity) entityLivingBase, angle);
    }
     ...
     */
    protected void preRenderScale(TerrorBirdEntity entity, float par2) {
    ...
    protected void preRenderCallback(EntityLivingBase par1EntityLivingBase, float par2) {
        this.preRenderScale((TerrorBirdEntity) par1EntityLivingBase, par2);
    }

    protected ResourceLocation func_110919_a(TerrorBirdEntity entity) {
        switch (entity.getSkin()) {
            case 0:
            default:
                if (entity.isChild()) {
    ...
    protected float getWingRotation(TerrorBirdEntity entityLiving, float par2) {
    ...
    public void doRender(EntityLiving entityLiving, double par2, double par4, double par6, float par8, float par9) {
        this.renderDodo((TerrorBirdEntity) entityLiving, par2, par4, par6, par8, par9);
    }

    protected ResourceLocation getEntityTexture(Entity entity) {
        return this.func_110919_a((TerrorBirdEntity) entity);
    }
    ...
    public void doRender(Entity entity, double par2, double par4, double par6, float par8, float par9) {
        this.renderDodo((TerrorBirdEntity) entity, par2, par4, par6, par8, par9);
    }
}
