...
public class ClientProxy extends CommonProxy
{
    ...
    public void init()
    {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCultivatedDodoEgg.class, new RenderSnowball(FAItemRegistry.cultivatedDodoEgg));
        RenderingRegistry.registerEntityRenderingHandler(EntityConfuciusornisEgg.class, new RenderSnowball(FAItemRegistry.confuciusornisEgg));
        RenderingRegistry.registerEntityRenderingHandler(EntityCultivatedConfuciusornisEgg.class, new RenderSnowball(FAItemRegistry.cultivatedConfuciusornisEgg));
