...
public class GuiNotebook extends GuiScreen {
    ...
    public void addTextByPage(int page) {
        ...
        if (page == 1) {
            /*
			 * //TODO String[] dinoArrayLeft =
			 * PediaDinosaur.ankylosaurus_leftPage; String[] dinoArrayRight =
			 * PediaDinosaur.ankylosaurus_rightPage;
			 * 
			 * for (int i = 0; i < dinoArrayLeft.length; i++) {
			 * fontRenderer.drawString(dinoArrayLeft[i], var3, var4 + (12 * i),
			 * 0x2b2b2b, false); }
			 * 
			 * for (int i2 = 0; i2 < dinoArrayLeft.length; i2++) {
			 * fontRenderer.drawString(dinoArrayRight[i2], var3 + 120, var4 +
			 * (12 * i2), 0x2b2b2b, false); }
			 */
            // fontRenderer.drawString("This needs to be dynamically loaded from a text file.",
            // var3, var4+65, 0x2b2b2b, false);
        }
    ...
    public void addButtonByPage(int page) {
		...
		/*
		 * if(page == 6) { this.buttonList.add(this.buttonIcon = new
		 * FossilGuiButton(7, centerX+35, centerY+75, 10));
		 * this.buttonList.add(this.buttonIcon = new FossilGuiButton(8,
		 * centerX+75, centerY+55, 12)); this.buttonList.add(this.buttonIcon =
		 * new FossilGuiButton(9, centerX+115, centerY+75, 14));
		 * this.buttonList.add(this.buttonIcon = new FossilGuiButton(10,
		 * centerX+75, centerY+95, 16)); }
		 */
