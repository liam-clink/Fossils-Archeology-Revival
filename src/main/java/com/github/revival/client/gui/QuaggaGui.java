...
public class QuaggaGui extends GuiContainer {
    ...
    private QuaggaEntity entity;
    private float mouseX;
    private float mouseY;

    public QuaggaGui(IInventory playerInventory, IInventory entityInventory, QuaggaEntity entity) {
        super(new QuaggaContainer(playerInventory, entityInventory, entity));
