...
public class PediaGui extends GuiContainer {
    ...
    public PediaGui(/*InventoryPlayer var1*/) {
    ...
    */
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        if (bookPages == 0) {
            if (Revival.toPedia instanceof DinoEggEntity) {
                ((DinoEggEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof PregnantCowEntity) {
                ((PregnantCowEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof PregnantPigEntity) {
                ((PregnantPigEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof PregnantHorseEntity) {
                ((PregnantHorseEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof PregnantSheepEntity) {
                ((PregnantSheepEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof NewPrehistoricEntity) {
                ((NewPrehistoricEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof FishBaseEntity) {
                ((FishBaseEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof QuaggaEntity) {
                ((QuaggaEntity) Revival.toPedia).showPedia(this);
            } else if (Revival.toPedia instanceof TerrorBirdEntity) {
                ((TerrorBirdEntity) Revival.toPedia).showPedia(this);
            }
        } else {
            if (Revival.toPedia instanceof NewPrehistoricEntity) {
                ((NewPrehistoricEntity) Revival.toPedia).showPedia2(this, ((NewPrehistoricEntity) Revival.toPedia).selfType.toString());
            } else if (Revival.toPedia instanceof FishBaseEntity) {
                ((FishBaseEntity) Revival.toPedia).showPedia2(this);
            } else if (Revival.toPedia instanceof QuaggaEntity) {
                ((QuaggaEntity) Revival.toPedia).showPedia2(this);
            } else if (Revival.toPedia instanceof TerrorBirdEntity) {
                ((TerrorBirdEntity) Revival.toPedia).showPedia2(this);
            }
        }
    }
