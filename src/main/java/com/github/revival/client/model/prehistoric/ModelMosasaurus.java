...
public class ModelMosasaurus extends ModelPrehistoric {
    ...
    private AdvancedModelRenderer FrontFlipper_Right;
    private AdvancedModelRenderer FrontFlipper_Left;
    private AdvancedModelRenderer LowerBody;
    private AdvancedModelRenderer Tail;
    private AdvancedModelRenderer Tail1;
    private AdvancedModelRenderer Lower_Caudal_Left;
    private AdvancedModelRenderer Lower_Caudal_Right;
    private AdvancedModelRenderer Upper_Caudal;
    private AdvancedModelRenderer BackFlipper_Right;
    private AdvancedModelRenderer BackFlipper_Left;
    private AdvancedModelRenderer Neck;
    private AdvancedModelRenderer Head;
    private AdvancedModelRenderer JawTop;
    private AdvancedModelRenderer Teeth;
    private AdvancedModelRenderer JawBottomBase;
    private AdvancedModelRenderer JawBottom;
    ...
    public ModelMosasaurus() {
        ...
        FrontFlipper_Right = new AdvancedModelRenderer(this, "FrontFlipper_Right");
        ...
        FrontFlipper_Left = new AdvancedModelRenderer(this, "FrontFlipper_Left");
        ...
        Lower_Caudal_Left = new AdvancedModelRenderer(this, "Lower_Caudal_Left");
        ...
        Lower_Caudal_Right = new AdvancedModelRenderer(this, "Lower_Caudal_Right");
        ...
        Upper_Caudal = new AdvancedModelRenderer(this, "Upper_Caudal");
        ...
        BackFlipper_Right = new AdvancedModelRenderer(this, "BackFlipper_Right");
        ...
        BackFlipper_Left = new AdvancedModelRenderer(this, "BackFlipper_Left");
        ...
        JawTop = new AdvancedModelRenderer(this, "JawTop");
        ...
        JawBottomBase = new AdvancedModelRenderer(this, "JawBottomBase");
        ...
        JawBottom = new AdvancedModelRenderer(this, "JawBottom");
