...
public class ModelCompsognathus extends MowzieModelBase {
    ...
    public ModelCompsognathus() {
        ...
        ModelUtils.setRotateAngle(RightFoot, 0.22759093446006054F, 0.0F, 0.0F);
        ...
        this.leftLowerLeg.setRotationPoint(0.5F, 4.0F, 0.0F);
        this.leftLowerLeg.addBox(-0.51F, -0.2F, 0.3F, 1, 5, 1, 0.0F);
        ...
        ModelUtils.setRotateAngle(leftFoot, 0.22759093446006054F, 0.0F, 0.0F);
        ...
        ModelUtils.setRotateAngle(head, -0.6829473363053812F, 0.0F, 0.0F);
        ...
        this.RightLowerArm.setRotationPoint(0.1F, 1.9F, 0.0F);
        this.RightLowerArm.addBox(-1.1F, -0.6F, -0.6F, 1, 3, 1, 0.0F);
