...
public class DeinonychusModel extends NewPrehistoricModel {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (((DeinonychusEntity) entity).getAnimation() != DeinonychusEntity.animation_attack && ((DeinonychusEntity) entity).ridingEntity != null) {
            ...
            DeinonychusEntity dino = (DeinonychusEntity) entity;
            float speed3 = 0.5F;
