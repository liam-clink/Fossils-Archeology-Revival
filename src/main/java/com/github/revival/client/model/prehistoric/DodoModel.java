...
public class DodoModel extends NewPrehistoricModel {
    ...
    public void animate(IAnimated entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        animator.setAnimationId(NewPrehistoricEntity.animation_speak.animationId);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        DodoEntity dodo = (DodoEntity) entity;
        float speed = 1.8F;
        float speed2 = 0.1F;
