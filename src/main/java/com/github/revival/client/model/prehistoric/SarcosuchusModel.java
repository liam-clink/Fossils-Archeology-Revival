...
public class SarcosuchusModel extends PrehistoricModel {
   ...
   /* public void setRotationAngles(float f, float f1, float f2, float f3,
                                  float f4, float f5, Entity entity)
    {
        ...
        if (entity instanceof SarcosuchusEntity)
        {
            SarcosuchusEntity sarco = (SarcosuchusEntity) entity;
