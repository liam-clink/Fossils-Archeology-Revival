...
public class ModelPlesiosaurus extends ModelPrehistoric {
    ...
    private AdvancedModelRenderer leftarm;
    private AdvancedModelRenderer rightarm;
    private AdvancedModelRenderer tail1;
    private AdvancedModelRenderer tail2;
    private AdvancedModelRenderer tail3;
    private AdvancedModelRenderer Neck1;
    private AdvancedModelRenderer Neck2;
    private AdvancedModelRenderer Neck4;
    private AdvancedModelRenderer Neck3;
    ...
    public ModelPlesiosaurus() {
        ...
        Body.addChild(tail1);
        this.Neck1 = new AdvancedModelRenderer(this, "Neck1");
