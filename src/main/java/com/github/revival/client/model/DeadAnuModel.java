...
/**
 * PigBossModel - Either Mojang or a mod author
 * Created using Tabula 4.1.1
 */
public class DeadAnuModel extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (entity instanceof AnuDeadEntity) {
            if (((AnuDeadEntity) entity).deathTicks > 40) {
                alpha = 1 - (((((AnuDeadEntity) entity).deathTicks - 40) / 9) * 0.01F);
