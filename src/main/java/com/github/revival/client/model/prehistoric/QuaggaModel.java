...
public class QuaggaModel extends ModelBase {
    ...
    public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7) {
        QuaggaEntity entityhorse = (QuaggaEntity) par1Entity;
    ...
    public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4) {
        ...
        QuaggaEntity entityhorse = (QuaggaEntity) par1EntityLivingBase;
        float f8 = entityhorse.getGrassEatingAmount(par4);
        float f9 = entityhorse.getRearingAmount(par4);
        float f10 = 1.0F - f9;
        float f11 = entityhorse.getMouthOpenness(par4);
        boolean flag = entityhorse.timer1 != 0;
