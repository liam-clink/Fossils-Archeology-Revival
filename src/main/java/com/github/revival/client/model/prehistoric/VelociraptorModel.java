...
import com.github.revival.server.entity.mob.DeinonychusEntity;
import com.github.revival.server.entity.mob.VelociraptorEntity;
...
public class VelociraptorModel extends NewPrehistoricModel {
    ...
    public void animate(IAnimated entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        animator.setAnimationId(DeinonychusEntity.animation_attack.animationId);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (((VelociraptorEntity) entity).getAnimation() != VelociraptorEntity.animation_attack && ((VelociraptorEntity) entity).ridingEntity != null) {
            ...
            VelociraptorEntity dino = (VelociraptorEntity) entity;
            float speed3 = 0.5F;
        ...
        //((ChainBuffer)((VelociraptorEntity)entity).tailbuffer).applyChainSwingBuffer(tailParts);
    ...
    public void renderHeldItem(PrehistoricRenderer prehistoricRenderer, EntityLiving entity, float f) {
        GL11.glColor3f(1.0F, 1.0F, 1.0F);
        prehistoricRenderer.superRenderEquippedItems(entity, f);
        ...
        if (itemstack1 != null) {
            ...
            if (item instanceof ItemBlock) {
                ...
                prehistoricRenderer.getRenderManager().itemRenderer.renderItem(entity, itemstack1, 0);
        ...
        if (itemstack != null && itemstack.getItem() != null) {
            ...
            if (itemstack.getItem().requiresMultipleRenderPasses()) {
                for (i = 0; i < itemstack.getItem().getRenderPasses(itemstack.getItemDamage()); ++i) {
                    ...
                    prehistoricRenderer.getRenderManager().itemRenderer.renderItem(entity, itemstack, i);
                }
            } else {
                ...
                prehistoricRenderer.getRenderManager().itemRenderer.renderItem(entity, itemstack, 0);
            }
