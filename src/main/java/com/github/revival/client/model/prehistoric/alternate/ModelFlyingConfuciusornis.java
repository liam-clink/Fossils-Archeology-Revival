...
public class ModelFlyingConfuciusornis extends ModelPrehistoric {
    ...
    public AdvancedModelRenderer leftTail4;
    public AdvancedModelRenderer leftTail5;
    public AdvancedModelRenderer leftTailFan;
    public AdvancedModelRenderer rightTail2;
    public AdvancedModelRenderer rightTail3;
    public AdvancedModelRenderer rightTail4;
    public AdvancedModelRenderer rightTail5;
    public AdvancedModelRenderer rightTailFan;
    public AdvancedModelRenderer leftWingPivot;
    public AdvancedModelRenderer rightWingPivot;
    ...
    public ModelFlyingConfuciusornis() {
        ...
        this.leftWing1 = new AdvancedModelRenderer(this, 37, 14);
        ...
        this.leftTail4 = new AdvancedModelRenderer(this, 2, 21);
        ...
        this.rightTail4 = new AdvancedModelRenderer(this, 2, 21);
        this.rightTail4.setRotationPoint(0.0F, 0.0F, 4.0F);
        this.rightTail4.addBox(-0.5F, 0.0F, 0.0F, 1, 0, 4, 0.0F);
        this.leftWing2 = new AdvancedModelRenderer(this, 48, 14);
        ...
        this.rightWingPivot = new AdvancedModelRenderer(this, 0, 0);
        ...
        this.rightWing1 = new AdvancedModelRenderer(this, 37, 14);
        ...
        this.rightWing2 = new AdvancedModelRenderer(this, 48, 14);
        ...
        this.leftTail5 = new AdvancedModelRenderer(this, 0, 26);
	 ...
	 * par4, float par5, float par6) { this.head.rotateAngleX = par5 / (180F /
	 * (float) Math.PI); this.head.rotateAngleZ = par4 / (180F / (float)
	 * Math.PI); //this.rightLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662F) *
	 * 1.4F * par2; //this.leftLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662F
	 * + (float)Math.PI) * 1.4F * par2; this.leftWing1.rotateAngleZ = (0.4F *
	 * -MathHelper.cos(par1 * (float) 0.2F + par2));
	 * this.rightWing1.rotateAngleZ = (-0.4F * -MathHelper.cos(par1 * (float)
	 * 0.2F + par2)); this.leftWing2.rotateAngleZ = (0.2F * -MathHelper.cos(par1
	 * * (float) 0.2F + par2)); this.rightWing2.rotateAngleZ = (-0.2F *
	 * -MathHelper.cos(par1 * (float) 0.2F + par2)); this.leftTail1.rotateAngleX
	 * = 0.1F * MathHelper.sin(par3 * (float) 0.1F + (par2 + 2));
	 * this.leftTail2.rotateAngleX = -0.06F * MathHelper.sin(par3 * (float) 0.1F
	 * + (par2 + 2)); this.leftTail3.rotateAngleX = 0.06F * MathHelper.sin(par3
	 * * (float) 0.1F + (par2 + 2)); this.leftTail4.rotateAngleX = -0.06F *
	 * MathHelper.sin(par3 * (float) 0.1F + (par2 + 2));
	 * this.rightTail1.rotateAngleX = 0.1F * MathHelper.sin(par3 * (float) 0.1F
	 * + (par2 + 2)); this.rightTail2.rotateAngleX = -0.06F *
	 * MathHelper.sin(par3 * (float) 0.1F + (par2 + 2));
	 * this.rightTail3.rotateAngleX = 0.06F * MathHelper.sin(par3 * (float) 0.1F
	 * + (par2 + 2)); this.rightTail4.rotateAngleX = -0.06F *
	 * MathHelper.sin(par3 * (float) 0.1F + (par2 + 2)); }
	 */
}
