...
public class FlyingPteranodonModel extends PrehistoricModel {
    ...
    public FlyingPteranodonModel() {
        ...
        this.Body2 = new MowzieModelRenderer(this, 22, 32);
        ...
        this.Fibre3 = new MowzieModelRenderer(this, 34, 34);
        ...
        this.Leg2 = new MowzieModelRenderer(this, 20, 41);
        ...
        this.Neck2 = new MowzieModelRenderer(this, 0, 41);
        ...
        this.Crest = new MowzieModelRenderer(this, 30, 51);
        ...
        this.WingR2 = new MowzieModelRenderer(this, 0, 18);
        ...
        this.HandR = new MowzieModelRenderer(this, 58, 32);
        ...
        this.Fibre = new MowzieModelRenderer(this, 34, 34);
        ...
        this.WingL2 = new MowzieModelRenderer(this, 31, 18);
        ...
        this.Fibre4 = new MowzieModelRenderer(this, 34, 34);
        ...
        this.Beak2 = new MowzieModelRenderer(this, 38, 55);
        ...
        this.Neck = new MowzieModelRenderer(this, 0, 48);
        ...
        this.Beaka = new MowzieModelRenderer(this, 18, 54);
        ...
        this.HandL = new MowzieModelRenderer(this, 58, 32);
        ...
        this.Beakb = new MowzieModelRenderer(this, 18, 54);
        this.Beakb.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Beakb.addBox(-1.0001F, 0.0F, -7.0F, 2, 2, 8);
        this.Leg = new MowzieModelRenderer(this, 20, 41);
