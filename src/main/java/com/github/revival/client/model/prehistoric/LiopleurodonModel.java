...
/**
 * LiopleurodonModel - Either Mojang or a mod author
 * Created using Tabula 4.1.1
 */
public class LiopleurodonModel extends PrehistoricModel {
    public MowzieModelRenderer LowerBody;
    public MowzieModelRenderer BackFlipper_Right;
    public MowzieModelRenderer Tail;
    public MowzieModelRenderer BackFlipper_Left;
    public MowzieModelRenderer UpperBody;
    public MowzieModelRenderer Tail1;
    public MowzieModelRenderer Tail2;
    public MowzieModelRenderer Neck;
    public MowzieModelRenderer FrontFlipper_Right;
    public MowzieModelRenderer FrontFlipper_Left;
    public MowzieModelRenderer Head;
    public MowzieModelRenderer JawTop;
    public MowzieModelRenderer JawBottomBase;
    ...
    public LiopleurodonModel() {
        ...
        this.FrontFlipper_Right = new MowzieModelRenderer(this, 72, 45);
        ...
        this.JawBottomBase = new MowzieModelRenderer(this, 0, 27);
        ...
        this.JawBottom = new MowzieModelRenderer(this, 0, 37);
        ...
        this.LowerBody = new MowzieModelRenderer(this, 34, 9);
        ...
        this.Tail1 = new MowzieModelRenderer(this, 79, 13);
        ...
        this.BackFlipper_Right = new MowzieModelRenderer(this, 59, 49);
