...
public class ItemDinoEgg extends Item
{
    ...
    public ItemDinoEgg(int DinoType0)
    {
        super();
    ...
    public void registerIcons(IIconRegister par1IconRegister)
    {
        this.itemIcon = par1IconRegister.registerIcon("fossil:prehistoric/dinoEggs/"
                + EnumPrehistoric.values()[DinoType].name() + "_Egg");
    }
            ...
            else
            {
                if (var23.typeOfHit == MovingObjectType.BLOCK)
                {
                    ...
                    if (!var2.isRemote)
                    {
                        ...
                        EnumPrehistoric i = this.GetTypeFromInt(var3.inventory.getCurrentItem().getItem());

                        if (!spawnCreature(var2, i,
    ...
    private EnumPrehistoric GetTypeFromInt(Item var1)
    {
        return EnumPrehistoric.values()[EnumPrehistoric.getIndex(var1)];
    }
}
