...
public class EntityElasmotherium extends EntityPrehistoric
{
    ...
    {
        return Revival.modid + ":" + "elasmotherium_living";
    }
    ...
    {
        return Revival.modid + ":" + "elasmotherium_hurt";
    }
    ...
    {
        return Revival.modid + ":" + "elasmotherium_death";
    }
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (itemstack.getItem() == FAItemRegistry.whip && this.isTamed() && !this.isChild() && !this.worldObj.isRemote
    ...
    public void ShowPedia(GuiPedia p0)
    {
        ...
        p0.reset();
        p0.PrintPictXY(new ResourceLocation(Revival.modid + ":" + "textures/items/" + "Elasmotherium/" + "Elasmotherium" + "_DNA.png"), ((p0.xGui / 2) + (p0.xGui / 4)), 7, 16, 16); //185
