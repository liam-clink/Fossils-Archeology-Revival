...
import com.github.revival.common.api.IWaterDino;
import com.github.revival.common.entity.ai.DinoAIAttackOnCollide;
...
public class EntitySpinosaurus extends EntityDinosaur implements IWaterDino
{
    ...
    public void onKillEntity(EntityLiving var1)
    {
        ...
        if (this.getDinoAge() >= 3)
        {
            this.worldObj.playSoundAtEntity(this, Revival.modid + "trex_scream", this.getSoundVolume() * 2.0F, 1.0F);
        }
    }
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        {
            /*
            if (var2.itemID == Revival.gem.itemID)
            {
                ...
                else
                {
                    if (!this.isWeak())
                    {
                        ...
                        {
                            Revival.ShowMessage(StatCollector.translateToLocal(LocalizationStrings.STATUS_GEM_ERROR_HEALTH), var1);
                        }
                    }
                    ...
                    if (!this.isAdult())
                    {
                        if (!this.worldObj.isRemote)
                        {
                            Revival.ShowMessage(StatCollector.translateToLocal(LocalizationStrings.STATUS_GEM_ERROR_YOUNG), var1);
                        }
                    }
