...
public class EntityCoelacanth extends EntityWaterMob
{
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        if (var2 == null)
        {
            ...
            ItemStack var3 = new ItemStack(FAItemRegistry.livingCoelacanth, 1, getSkin());
    ...
    public void ShowPedia(GuiPedia p0)
    {
        ...
        {
            case 0:
                p0.PrintPictXY(ocean, ((p0.xGui / 2) + (p0.xGui / 4)), 7, 16, 16);
                break;
            case 1:
                p0.PrintPictXY(river, ((p0.xGui / 2) + (p0.xGui / 4)), 7, 16, 16);
                break;
            case 2:
                p0.PrintPictXY(swamp, ((p0.xGui / 2) + (p0.xGui / 4)), 7, 16, 16);
                break;
            default:
                p0.PrintPictXY(ocean, ((p0.xGui / 2) + (p0.xGui / 4)), 7, 16, 16);
                break;
