...
public class EntityNautilus extends EntityWaterMob
{
    ...
    protected void dropFewItems(boolean var1, int var2)
    {
        ...
        if (var3 <= 3)
        {
            this.dropItem(FAItemRegistry.emptyShell, 1);
//            this.dropItem(EnumDinoType.Nautilus.DropItem.itemID, 1);
        }
        else
        {
            this.dropItem(FAItemRegistry.magicConch, 1);
        }
    }
    ...
    public void ShowPedia(GuiPedia p0)
    {
        ...
        p0.PrintPictXY(new ResourceLocation(Revival.modid + ":" + "textures/items/" + "Nautilus" + "_Egg.png"), ((p0.xGui / 2) + (p0.xGui / 4)), 7, 16, 16); //185
