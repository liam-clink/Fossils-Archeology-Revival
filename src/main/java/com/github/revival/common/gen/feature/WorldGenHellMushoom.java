...
public class WorldGenHellMushoom extends WorldGenerator
{
    /**
    ...
    public WorldGenHellMushoom(int type)
    {
        super(true);
        this.mushroomType = type;
    }

    public WorldGenHellMushoom()
    {
        super(false);
    }
    ...
    public boolean generate(World world, Random rand, int x, int y, int z)
    {
        ...
        if (y >= 1 && y + i1 + 1 < 256)
        {
            ...
            else
            {
                ...
                if (block1 != Blocks.dirt && block1 != Blocks.grass && block1 != Blocks.netherrack)
                {
                    return false;
                }
                else
                {
                    ...
                    for (k1 = k2; k1 <= y + i1; ++k1)
                    {
                        ...
                        for (int l2 = x - l1; l2 <= x + l1; ++l2)
                        {
                            for (int i2 = z - l1; i2 <= z + l1; ++i2)
                            {
                                ...
                                {
                                    this.setBlockAndNotifyAdequately(world, l2, k1, i2, Block.getBlockById(Block.getIdFromBlock(Blocks.brown_mushroom_block) + l), j2);
                                }
                            }
                        }
                    }
                    ...
                    for (k1 = 0; k1 < i1; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(world, x, y + k1, z, Block.getBlockById(Block.getIdFromBlock(Blocks.brown_mushroom_block) + l), 10);
                        }
                    }
