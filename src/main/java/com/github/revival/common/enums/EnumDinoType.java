...
}public enum EnumDinoType
{
    ...
    Sarcosuchus(EntitySarcosuchus.class, C.TAME | C.CARNIVORE),
     ...
     * Params: Class, Flags
     */
    EnumDinoType(Class class0, int f0)
    {
    ...
    public static void init()
    {
        ...
        Plesiosaur.setItems(FAItemRegistry.emptyShell);
        ...
        Spinosaurus.setItems(FAItemRegistry.skullStick);
        ...
        TRex.setItems(FAItemRegistry.skullStick);
        TRex.setAges(5, 12, -1);
    ...
    {
        EnumDinoType.sizeBaby = sizeBaby;
        EnumDinoType.sizeTeen = sizeTeen;
        EnumDinoType.sizeAdult = sizeAdult;
    }
