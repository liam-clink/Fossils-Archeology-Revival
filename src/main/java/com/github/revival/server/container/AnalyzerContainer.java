    ...
    public AnalyzerContainer(InventoryPlayer var1, TileEntity var2) {
        ...
        for (var3 = 0; var3 < 3; ++var3) {
            for (var4 = 0; var4 < 3; ++var4) {
                this.addSlotToContainer(new Slot(this.analyzer,
                        var4 + var3 * 3, 20 + var4 * 18, 17 + var3 * 18));
            }
        }

        // Active output slot, 9
        this.addSlotToContainer(new SlotFurnace(var1.player, this.analyzer, 9,
                116, 21));

        // other output slots, 10-12
        for (var3 = 0; var3 < 3; ++var3) {
            this.addSlotToContainer(new SlotFurnace(var1.player, this.analyzer,
                    10 + var3, 111 + 18 * var3, 53));
