...
public class FossilEntities {
	...
	public static void registerEntities() {		
		EntityRegistry.registerModEntity(EntityStoneboard.class, "StoneBoard", 1, Revival.INSTANCE, 250, Integer.MAX_VALUE, false);
		EntityRegistry.registerModEntity(EntityJavelin.class, "Javelin", 2, Revival.INSTANCE, 250, 5, true);
		EntityRegistry.registerModEntity(EntityAncientJavelin.class, "AncientJavelin", 3, Revival.INSTANCE, 250, 5, true);
		EntityRegistry.registerModEntity(EntityMLighting.class, "FriendlyLighting", 4, Revival.INSTANCE, 250, 5, true);
		...
		EntityRegistry.registerModEntity(EntityDinoEgg.class, "DinoEgg", 8, Revival.INSTANCE, 250, 1, false);
		EntityRegistry.registerModEntity(EntityFriendlyPigZombie.class, "FriendlyPigZombie", 12, Revival.INSTANCE, 250, 3, true);
		EntityRegistry.registerModEntity(EntityDodoEgg.class, "DodoEgg", 26, Revival.INSTANCE, 250, 5, true);
		...
		EntityRegistry.registerModEntity(EntityTerrorBirdEgg.class, "TerrorBirdEgg", 32, Revival.INSTANCE, 250, 5, true);
		EntityRegistry.registerModEntity(EntityAnuEffect.class, "AnuEffect", 34, Revival.INSTANCE, 250, 5, true);
		registerSpawnable(EntityAnubite.class, "Anubite", 39, 0X2E1E14, 0X601200);
		EntityRegistry.registerModEntity(EntityAnuDead.class, "AnuDead", 41, Revival.INSTANCE, 250, 3, true);
		...
		EntityRegistry.registerModEntity(EntityToyTetheredLog.class, "ToyTetheredLog", 104, Revival.INSTANCE, 250, 5, true);
		EntityRegistry.registerModEntity(EntityToyScratchingPost.class, "ToyScratchingPost", 105, Revival.INSTANCE, 250, 5, true);
	...
	public static void registerSpawnable(Class entityClass, String name, int entityId, int mainColor, int subColor){
		EntityRegistry.registerModEntity(entityClass, name, entityId, Revival.INSTANCE, 250, 1, true);
