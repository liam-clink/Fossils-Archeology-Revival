...
public class FossilAchievementHandler {
	...
	public static void loadAchievements() {
		...
		// usurper = new Achievement("achievement.usurper", "usurper", 8, -3,
		// new ItemStack(Revival.skull, 1, 10),
		// (Achievement)firstDino).registerStat().setSpecial();
