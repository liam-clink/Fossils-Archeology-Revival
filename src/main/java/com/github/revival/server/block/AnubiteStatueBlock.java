...
import com.github.revival.server.entity.mob.AnubiteEntity;
...
public class AnubiteStatueBlock extends BlockContainer implements ISubBlocksBlock {
    private int counter = 0;

    public AnubiteStatueBlock() {
        super(Material.rock);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
        ...
        AnubiteEntity newMob = new AnubiteEntity(world);
        if (!world.isRemote) {
