...
import com.github.revival.server.block.FeederBlock;
...
public class FeederTile extends TileEntity implements IInventory,
        ISidedInventory {
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (var2 != (((this.MeatCurrent > 0) ? 2 : 0) + ((this.VegCurrent > 0) ? 1
                    : 0))) {
                FeederBlock.updateFurnaceBlockState(this.VegCurrent > 0,
                        this.MeatCurrent > 0, this.worldObj, this.xCoord,
                        this.yCoord, this.zCoord);
                // FeederBlock.updateFurnaceBlockState(var4, this.worldObj,
    ...
    public int Feed(DinosaurEntity dinosaur, EnumPrehistoric dinotype) {
        int feedamount = 0;
	 ...
	 * return false; } }
	 * 
	 * @Deprecated public void Feed(DinosaurEntity var1, EnumDinoEating var2) {
