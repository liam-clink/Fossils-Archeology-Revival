...
import com.github.revival.server.block.WorktableBlock;
...
public class WorktableTile extends TileEntity implements IInventory,
        ISidedInventory {
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (var1 != this.furnaceBurnTime > 0) {
                var2 = true;
                WorktableBlock.updateFurnaceBlockState(
