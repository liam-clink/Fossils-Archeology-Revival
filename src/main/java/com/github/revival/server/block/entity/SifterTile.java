...
import com.github.revival.server.block.SifterBlock;
...
public class SifterTile extends TileEntity implements IInventory,
        ISidedInventory {
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (var1 != this.sifterBurnTime > 0) {
                var2 = true;
                SifterBlock.updateFurnaceBlockState(this.sifterBurnTime > 0,
