...
public class TileEntityAnalyzer extends TileEntity implements IInventory, ISidedInventory {
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            if (EnumPrehistoric.getDNA(this.analyzerItemStacks[this.RawIndex].getItem()) != null) {
                itemstack = new ItemStack(EnumPrehistoric.getDNA(this.analyzerItemStacks[this.RawIndex].getItem()), 1);
            }
            ...
            if (itemstack != null) {
                if (itemstack.getItem() == Items.dye || itemstack.getItem() == FAItemRegistry.INSTANCE.fernSeed || itemstack.getItem() == FAItemRegistry.INSTANCE.stoneboard || itemstack.getItem() == Items.flint || itemstack.getItem() == Item.getItemFromBlock(Blocks.gravel) || itemstack.getItem() == FAItemRegistry.INSTANCE.relic || itemstack.getItem() == FAItemRegistry.INSTANCE.brokenSapling || itemstack.getItem() == Item.getItemFromBlock(Blocks.sand) || itemstack.getItem() == Items.string || itemstack.getItem() == Items.beef) {
