...
public class WorktableBlock extends BlockContainer {
    ...
    public boolean onBlockActivated(World var1, int var2, int var3, int var4,
        ...
        if (var1.isRemote) {
            ...
            WorktableTile tileentityworktable = (WorktableTile) var1
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4,
        ...
        if (par6ItemStack.hasDisplayName()) {
            ((WorktableTile) par1World.getTileEntity(par2, par3, par4))
    ...
    public void breakBlock(World world, int x, int y, int z, Block block,
        ...
        if (!keepFurnaceInventory) {
            WorktableTile tileentity = (WorktableTile) world
                    .getTileEntity(x, y, z);
