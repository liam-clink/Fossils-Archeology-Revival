...
import com.github.revival.server.block.entity.AncientChestTile;
...
public class AncientChestBlock extends BlockContainer {
    private final Random rand = new Random();

    public AncientChestBlock() {
        super(Material.wood);
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block block) {
        ...
        AncientChestTile tile = (AncientChestTile) world.getTileEntity(x, y, z);
    ...
    public IInventory invActivated(World world, int x, int y, int z) {
        Object object = (AncientChestTile) world.getTileEntity(x, y, z);
