...
import com.github.revival.server.item.block.VaseKylixBlockItem;
...
public class VaseKylixBlock extends BlockContainer implements ISubBlocksBlock {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack) {
        ...
        ((VaseTile) tileentity).setVaseType(2);
