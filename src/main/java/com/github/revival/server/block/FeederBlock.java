...
public class FeederBlock extends BlockContainer {
    ...
    public FeederBlock(boolean isActive) {
        super(Material.iron);
        setHardness(3.5F);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if (world.isRemote) {
            ...
            FeederTile tileentity = (FeederTile) world
                    .getTileEntity(x, y, z);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z,
        ...
        if (itemstack.hasDisplayName()) {
            ((FeederTile) world.getTileEntity(x, y, z))
    ...
    public void breakBlock(World world, int x, int y, int z, Block block,
                           int var6) {
        FeederTile tileentity = (FeederTile) world.getTileEntity(x,
                y, z);
