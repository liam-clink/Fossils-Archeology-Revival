...
import com.github.revival.server.item.block.VaseAmphoraBlockItem;
...
public class VaseAmphoraBlock extends BlockContainer implements ISubBlocksBlock {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack) {
        ...
        ((VaseTile) tileentity).setVaseTypeMeta(par6ItemStack.getItemDamage());
        ((VaseTile) tileentity).setVaseType(1);
        ((VaseTile) tileentity).setVaseRotation(1);
    }
    ...
    public int getDamageValue(World par1World, int par2, int par3, int par4) {
        TileEntity tileentity = par1World.getTileEntity(par2, par3, par4);
        return tileentity != null && tileentity instanceof VaseTile ? ((VaseTile) tileentity).getVaseTypeMeta() : super.getDamageValue(par1World, par2, par3, par4);
    }
