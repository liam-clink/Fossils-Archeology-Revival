...
import com.github.revival.server.block.AnalyzerBlock;
...
public class AnalyzerTile extends TileEntity implements IInventory,
        ISidedInventory {
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (var1 != this.analyzerBurnTime > 0) {
                var2 = true;
                AnalyzerBlock.updateFurnaceBlockState(
