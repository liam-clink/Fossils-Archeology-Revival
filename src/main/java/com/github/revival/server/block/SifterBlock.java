...
public class SifterBlock extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        ...
        this.Top = this.isActive ? par1IconRegister
                .registerIcon("fossil:SifterTopActive") : par1IconRegister
                .registerIcon("fossil:SifterTop");
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block,
        ...
        if (!keepFurnaceInventory) {
            SifterTile tileentity = (SifterTile) world
                    .getTileEntity(x, y, z);
