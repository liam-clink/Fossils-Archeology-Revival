...
public class FigurineBlock extends BlockContainer implements ISubBlocksBlock {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack) {
        ...
        ((FigurineTile) tileentity).setFigurineType(par6ItemStack.getItemDamage());
        ((FigurineTile) tileentity).setFigurineRotation(1);
    }

    public TileEntity createNewTileEntity(World world, int par2) {
        return new FigurineTile();
    }

    public int getDamageValue(World par1World, int par2, int par3, int par4) {
        TileEntity tileentity = par1World.getTileEntity(par2, par3, par4);
        return tileentity != null && tileentity instanceof FigurineTile ? ((FigurineTile) tileentity).getFigurineType() : super.getDamageValue(par1World, par2, par3, par4);
    }
