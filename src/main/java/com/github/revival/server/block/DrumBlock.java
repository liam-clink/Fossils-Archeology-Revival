...
import com.github.revival.server.block.entity.DrumTile;
...
public class DrumBlock extends BlockContainer {
    IIcon Top1;
    IIcon Top2;
    IIcon Top3;
    IIcon Bottom;
	 ...
	 * var1.isBlockGettingPowered(var2, var3, var4); DrumTile var7 =
	 * (DrumTile)var1.getTileEntity(var2, var3, var4);
	 * 
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if (!world.isRemote) {
            DrumTile tileEntity = (DrumTile) world.getTileEntity(x,
                    y, z);
    ...
    public void onBlockClicked(World var1, int var2, int var3, int var4,
                               EntityPlayer var5) {
        if (!var1.isRemote) {
            DrumTile var6 = (DrumTile) var1.getTileEntity(var2,
                    var3, var4);
