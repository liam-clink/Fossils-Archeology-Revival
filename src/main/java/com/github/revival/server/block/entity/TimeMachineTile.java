...
public class TimeMachineTile extends TileEntity implements IInventory,
        ISidedInventory {
    ...
    private void restoreProgress() {
            ...
            for (int var5 = 0; var5 < 100; ++var5) {
                ...
                if (!this.isNonPerserveBlock(var6)) {
                    ...
                    if (var10 != 0) {
                        ...
                        this.getClass();
                        double var8 = (double) (var10002 - 100 / 2)
                                + (var1.nextDouble() - 0.5D);
                        double var7 = (double) this.restoringLayer
                                + var1.nextDouble();
                        this.getClass();
                        var10000.spawnParticle("portal", var8, var7,
                                (double) (var5 - 100 / 2)
                                        + (var1.nextDouble() - 0.5D),
                                (var1.nextDouble() - 0.5D) * 2.0D,
                                -var1.nextDouble(),
                                (var1.nextDouble() - 0.5D) * 2.0D);
                    }
                }
        ...
        this.worldObj.playSoundEffect((double) this.xCoord,
                (double) this.restoringLayer, (double) this.zCoord,
