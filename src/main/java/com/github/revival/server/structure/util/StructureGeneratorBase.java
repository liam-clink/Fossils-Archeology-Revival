...
public abstract class StructureGeneratorBase extends WorldGenerator {
	 ...
	 * @param offX
	 *            Amount to offset the structure's location along the east-west
	 *            axis
	 * @param offY
	 *            Amount to offset the structure's location along the vertical
	 *            axis
	 * @param offZ
	 *            Amount to offset the structure's location along the
	 *            north-south axis
	 */
	 ...
	 * 
	 * @param blockID
	 *            a valid block id, 0 to 4095 (4096 total)
	 * @param rotationType
	 ...
	 * 
	 * @param hanging
	 *            Must be an instance of ItemHangingEntity, such as
	 *            Items.painting
	 ...
	 * 
	 * @param text
	 *            A String array of no more than 4 elements; additional elements
	 *            will be ignored
	 ...
	 * 
	 * @param type
	 *            Type of skull: 0 Skeleton, 1 Wither Skeleton, 2 Zombie, 3
	 *            Human, 4 Creeper
	 * @param rot
	 ...
	 * 
	 * @param fakeID
	 *            ID you use to identify your 'event'. Absolute value must be
	 *            greater than 4095
	 * @param customData1
	 ...
	 * @param customData1
	 *            Custom data which can be used to subtype events for given
	 *            fakeID
	 * @param customData2
	 ...
	 * 
	 * @param x
	 *            Positive value spawns structure further away from player,
	 *            negative closer to or behind
	 * @param z
	 *            Positive value spawns structure more to the right, negative to
	 *            the left
	 */
