...
public class StoneboardEntity extends Entity implements IEntityAdditionalSpawnData {
    ...
    public StoneboardEntity(World var1) {
        super(var1);
        this.tickCounter1 = 0;
        this.direction = 0;
        this.yOffset = 0.0F;
    ...
    public StoneboardEntity(World var1, int var2, int var3, int var4, int var5) {
        this(var1);
        this.xPosition = var2;
        this.yPosition = var3;
        this.zPosition = var4;
    ...
    public StoneboardEntity(World var1, int var2, int var3, int var4, int var5, String var6) {
        this(var1);
        this.xPosition = var2;
        this.yPosition = var3;
        this.zPosition = var4;
    ...
    public boolean onValidSurface() {
        if (this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).size() > 0)     //test for collisions
        {
            ...
            for (int i = 0; i < collidingEntities.size(); i++) {
                if ((collidingEntities.get(i) instanceof StoneboardEntity) || (collidingEntities.get(i) instanceof EntityHanging))// || (collidingEntities.get(i) instanceof EntityHanging))this line seems not to be necessary
                {
                    return false;
                }
            }
