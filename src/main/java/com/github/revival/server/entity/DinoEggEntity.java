...
import com.github.revival.client.gui.PediaGui;
...
public class DinoEggEntity extends Entity implements IEntityAdditionalSpawnData {
    ...
    public DinoEggEntity(World var1, EnumPrehistoric var12) {
        super(var1);
        //this.BirthTick = 0;
        this.ParentOwner = "";
    ...
    public DinoEggEntity(World var1) {
        this(var1, (EnumPrehistoric) null);
    }

    public DinoEggEntity(World var1, EnumPrehistoric var2, DinosaurEntity var3) {
        this(var1, var2);
        this.ParentOwner = var3.getCommandSenderName();
    }

    public DinoEggEntity(World var1, double var2, double var4, double var6, EnumPrehistoric var8) {
        this(var1, var8);
        ...
        if (this.getBirthTick() <= -this.HatchingNeedTime) {
            if (player != null) {
                ...
                if (FMLCommonHandler.instance().getSide().isServer()) {
                    Revival.showMessage(var1 + StatCollector.translateToLocal("entity.fossil." + this.DinoInside.toString())/*DinosaurEntity.GetNameByEnum(this.DinoInside, false)*/ + var6, player);
                }
            }
            ...
            if (this.getBirthTick() >= this.HatchingNeedTime) {
                ...
                switch (this.DinoInside) {
                    case Triceratops:
                        var5 = new TriceratopsEntity(this.worldObj);
                        ...
                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SAVANNA)
                            ...
                            ((TriceratopsEntity) var5).setSubSpecies(1);
                            ...
                            ((TriceratopsEntity) var5).setSubSpecies(2);
                        } else {
                            ((TriceratopsEntity) var5).setSubSpecies(0);
                        }
                        break;

                    case Velociraptor:
                        var5 = new VelociraptorEntity(this.worldObj);
                        ...
                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.FOREST)
                            ...
                            ((VelociraptorEntity) var5).setSubSpecies(2);
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MOUNTAIN)) {
                            ((VelociraptorEntity) var5).setSubSpecies(1);
                            ...
                            ((VelociraptorEntity) var5).setSubSpecies(3);
                        } else {
                            ((VelociraptorEntity) var5).setSubSpecies(0);
                        }

                        break;

                    case Tyrannosaurus:
                        var5 = new TyrannosaurusEntity(this.worldObj);

                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.FOREST)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SWAMP)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.JUNGLE)) {
                            ((TyrannosaurusEntity) var5).setSubSpecies(1);
                        } else {
                            ((TyrannosaurusEntity) var5).setSubSpecies(0);
                        }
                        break;

                    case Pterosaur:
                        var5 = new PterosaurEntity(this.worldObj);
                        ...
                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.WASTELAND)
                            ...
                            ((PterosaurEntity) var5).setSubSpecies(2); //nether
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                            ...
                            ((PterosaurEntity) var5).setSubSpecies(1); //cold
                        } else {
                            ((PterosaurEntity) var5).setSubSpecies(0);

                        }
                        break;

                    case Plesiosaur:
                        var5 = new PlesiosaurusEntity(this.worldObj);
                        break;

                    case Mosasaurus:
                        var5 = new MosasaurusEntity(this.worldObj);

                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MOUNTAIN)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.WATER)) {
                            ((MosasaurusEntity) var5).setSubSpecies(1);
                        } else {
                            ((MosasaurusEntity) var5).setSubSpecies(2);
                        }

                        break;

                    case Liopleurodon:
                        var5 = new LiopleurodonEntity(this.worldObj);
                        break;

                    case Stegosaurus:
                        var5 = new StegosaurusEntity(this.worldObj);

                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SAVANNA)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SANDY)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MESA)) {
                            ((StegosaurusEntity) var5).setSubSpecies(2);
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MOUNTAIN)) {
                            ((StegosaurusEntity) var5).setSubSpecies(1);
                        } else {
                            ((StegosaurusEntity) var5).setSubSpecies(0);
                        }
                        break;

                    case Dilophosaurus:
                        var5 = new DilophosaurusEntity(this.worldObj);
                        ...
                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.NETHER) || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.JUNGLE)
                            ...
                            ((DilophosaurusEntity) var5).setSubSpecies(1);
                        } else {
                            ((DilophosaurusEntity) var5).setSubSpecies(0);
                        }
                        break;

                    case Allosaurus:
                        var5 = new AllosaurusEntity(this.worldObj);
                        ...
                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.HOT)
                            ...
                            ((AllosaurusEntity) var5).setSubSpecies(2);
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.JUNGLE)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SWAMP)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.FOREST)) {
                            ((AllosaurusEntity) var5).setSubSpecies(3);
                        } else {
                            ((AllosaurusEntity) var5).setSubSpecies(1);
                        }

                        break;

                    case Brachiosaurus:
                        var5 = new BrachiosaurusEntity(this.worldObj);
                        break;

                    case Spinosaurus:
                        var5 = new SpinosaurusEntity(this.worldObj);
                        break;

                    case Pachycephalosaurus:
                        var5 = new PachycephalosaurusEntity(this.worldObj);

                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.FOREST)) {
                            ((PachycephalosaurusEntity) var5).setSubSpecies(1);
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MOUNTAIN)) {
                            ((PachycephalosaurusEntity) var5).setSubSpecies(2);
                        } else {
                            ((PachycephalosaurusEntity) var5).setSubSpecies(3);
                        }

                        break;

                    case Compsognathus:
                        var5 = new CompsognathusEntity(this.worldObj);

                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MOUNTAIN)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.HOT)) {
                            ((CompsognathusEntity) var5).setSubSpecies(1);
                        } else {
                            ((CompsognathusEntity) var5).setSubSpecies(2);
                        }

                        break;

                    case Ankylosaurus:
                        var5 = new AnkylosaurusEntity(this.worldObj);
                        break;

                    case Deinonychus:
                        var5 = new DeinonychusEntity(this.worldObj);
                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MOUNTAIN)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.HILLS)) {
                            ((DeinonychusEntity) var5).setSubSpecies(1); //Grey
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.JUNGLE)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SWAMP)) {
                            ((DeinonychusEntity) var5).setSubSpecies(2); //Black
                        } else {
                            ((DeinonychusEntity) var5).setSubSpecies(3); //Brown
                        }
                        break;

                    case Gallimimus:
                        var5 = new GallimimusEntity(this.worldObj);

                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.PLAINS)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.HILLS)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.FOREST)) {
                            ((GallimimusEntity) var5).setSubSpecies(1); //Green
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.COLD)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.BEACH)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.WATER)) {
                            ((GallimimusEntity) var5).setSubSpecies(2); //Blue
                            ...
                            ((GallimimusEntity) var5).setSubSpecies(3); //Orange
                        } else {
                            ((GallimimusEntity) var5).setSubSpecies(4); //Brown
                        }
                        break;
                    case Sarcosuchus:
                        var5 = new SarcosuchusEntity(this.worldObj);
                        ...
                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SANDY)
                            ...
                            ((SarcosuchusEntity) var5).setSubSpecies(2); //desert
                        } else if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.JUNGLE)
                            ...
                            ((SarcosuchusEntity) var5).setSubSpecies(1); //swamp
                        } else {
                            ((SarcosuchusEntity) var5).setSubSpecies(0);

                        }
                        break;
                    case Ceratosaurus:
                        var5 = new CeratosaurusEntity(this.worldObj);

                        if (BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.NETHER) || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.JUNGLE)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.LUSH) || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.MESA)
                                || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.WASTELAND) || BiomeDictionary.isBiomeOfType(var3, BiomeDictionary.Type.SPOOKY)) {
                            ((CeratosaurusEntity) var5).setSubSpecies(1);
                        } else {
                            ((CeratosaurusEntity) var5).setSubSpecies(0);
                        }
                        break;
                ...
                if (var5 instanceof DinosaurEntity) {
                    if (player != null) {
                        player.addStat(FossilAchievementHandler.firstDino, 1);
                    }
                    if (((DinosaurEntity) var5).SelfType.isTameable() && player != null) {
                        if (((DinosaurEntity) var5).SelfType != EnumPrehistoric.Tyrannosaurus && ((DinosaurEntity) var5).SelfType != EnumPrehistoric.Allosaurus && ((DinosaurEntity) var5).SelfType != EnumPrehistoric.Sarcosuchus) {
                            // Tameable and player next to it
                            ((DinosaurEntity) var5).setTamed(true);
                            ((DinosaurEntity) var5).setOwner(player.getUniqueID().toString());
                            ((DinosaurEntity) var5).setOwnerDisplayName(player.getCommandSenderName());
                            // Locked to follow for first day
                            ((DinosaurEntity) var5).OrderStatus = EnumOrderType.Follow;
                        }
                    }
                }
