...
public abstract class EntityNewPrehistoric extends EntityTameable implements IPrehistoricAI, IAnimatedEntity {
    ...
    public boolean canSleep() {
        if (this.aiActivityType() == Activity.DIURINAL && !this.worldObj.isDaytime()) {
            ...
            return !(this.aiActivityType() == Activity.NOCTURNAL && this.worldObj.isDaytime()) && this.aiActivityType() == Activity.BOTH && rand.nextInt(200) == 0;
        }
    }
    ...
    public void onLivingUpdate() {
        ...
        if (!worldObj.isRemote && !this.isSitting() && this.getRNG().nextInt(1000) == 1 && !this.isRiding() && (this.getAnimation() == NO_ANIMATION || this.getAnimation() == animation_speak)) {
