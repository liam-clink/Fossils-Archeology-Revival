...
public class AnuEntity extends EntityMob implements IBossDisplayData, IRangedAttackMob {
    ...
    public void onDeath(DamageSource dmg) {
        ...
        AnuDeadEntity entity = new AnuDeadEntity(this.worldObj);
        if (!this.worldObj.isRemote) {
    ...
    public boolean attackEntityAsMob(Entity entity) {
        if (this.getRNG().nextInt(4) == 0) {
            this.worldObj.addWeatherEffect(new MLightingEntity(this.worldObj, entity.posX, entity.posY, entity.posZ));
        }
    ...
    public void spawnMobs(EntityLiving entity) {
        if (!this.worldObj.isRemote) {
            ...
            if (entity instanceof SentryPigmanEntity) {
                ((SentryPigmanEntity) entity).setCurrentItemOrArmor(0, new ItemStack(Items.iron_sword));
            }
    ...
    public void onLivingUpdate() {
        ...
        if (this.getAttackMode() == 2) {
            ...
            if (spawnPigmenChoice == 0) {
                ...
                this.spawnMobs(new SentryPigmanEntity(worldObj));
            }
    ...
    public void onKillEntity(EntityLivingBase entity) {
        if (entity instanceof EntityPlayer) {
            ...
            FAPlayerEntity.get(player).setKilledAnu(true);
        }
    }
