...
public class PregnantCowEntity implements IViviparous, IExtendedEntityProperties {
    ...
    public PregnantCowEntity(EntityCow cow) {
        this.cow = cow;
    ...
    public static final void register(EntityCow entity) {
        entity.registerExtendedProperties(PregnantCowEntity.PREGNANT_COW_PROP, new PregnantCowEntity(entity));
    }

    //Return EntityPregnant* properties for Vanilla entity mobs.
    public static final PregnantCowEntity get(EntityCow entity) {
        return (PregnantCowEntity) entity.getExtendedProperties(PREGNANT_COW_PROP);
    }
