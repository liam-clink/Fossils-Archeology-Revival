...
public class PregnantHorseEntity implements IViviparous, IExtendedEntityProperties {
    ...
    public PregnantHorseEntity(EntityHorse horse) {
        this.horse = horse;
    ...
    public static final void register(EntityHorse horse) {
        horse.registerExtendedProperties(PregnantHorseEntity.PREGNANT_HORSE_PROP, new PregnantHorseEntity(horse));
    }

    //Return EntityPregnantHorse properties for EntityHorse mobs.
    public static final PregnantHorseEntity get(EntityHorse horse) {
        return (PregnantHorseEntity) horse.getExtendedProperties(PREGNANT_HORSE_PROP);
    }
