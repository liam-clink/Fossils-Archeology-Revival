        ...
        if (this.theWatcher.getRNG().nextFloat() >= this.field_75331_e) {
            ...
            if (this.watchedClass == EntityPlayer.class) {
                ...
                if (closestEntity != null) {
                    if (closestEntity.boundingBox.maxX * 1.5F < theWatcher.boundingBox.maxX && closestEntity.boundingBox.minX * 1.5F > theWatcher.boundingBox.minX
                            && closestEntity.boundingBox.minZ * 1.5F < theWatcher.boundingBox.minZ && closestEntity.boundingBox.minZ * 1.5F > theWatcher.boundingBox.minZ) {
                        return false;
                    }
                }
            }
