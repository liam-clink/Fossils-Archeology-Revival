...
import com.github.revival.server.entity.ai.DinoAIStarvation;
...
public abstract class DinosaurEntity extends PrehistoricEntity implements IEntityAdditionalSpawnData {
    ...
    // DinosaurEntity Constructor
    public DinosaurEntity(World var1, EnumPrehistoric T0) {
        super(var1);
        this.SelfType = T0;
    ...
    public void HandleBreed() {
        ...
        if (this.isAdult()) {
            ...
            if (this.BreedTick == 0) {
                ...
                for (Object obj : list) {
                    if (obj instanceof DinosaurEntity) {
                        DinosaurEntity partner = (DinosaurEntity) obj;
                ...
                if ((new Random()).nextInt(100) < PartnerCount) {
                    DinoEggEntity var5;
                    var5 = new DinoEggEntity(this.worldObj, this.SelfType);
            ...
            if (itemstack != null) {
                ...
                } else// no food, but not nothing
                {
                    ...
                    if (FMLCommonHandler.instance().getSide().isClient()
                        ...
                        // DINOPEDIA
                        // DinosaurEntity.pediaingDino = this;
                        this.setPedia();
