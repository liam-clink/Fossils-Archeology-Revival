...
import com.github.revival.server.entity.ai.AnubiteAINearestAttackableTarget;
...
public class AnubiteEntity extends EntityMob {

    private int teleportDelay;

    public AnubiteEntity(World world) {
        super(world);
