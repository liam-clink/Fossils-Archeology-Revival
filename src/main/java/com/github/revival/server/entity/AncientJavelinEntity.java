...
public class AncientJavelinEntity extends JavelinEntity {
    ...
    public AncientJavelinEntity(World var1) {
        super(var1);
    }

    public AncientJavelinEntity(World var1, double var2, double var4, double var6) {
        super(var1, var2, var4, var6);
    }

    public AncientJavelinEntity(World var1, EntityPlayer var32, float var3, ToolMaterial var4, int damagevalue) {
        super(var1, var32, var3, var4, damagevalue);
        this.SelfMaterial = var4;
        this.damaged = damagevalue;
    }

    public AncientJavelinEntity(World var1, EntityLiving var2, float var3) {
