...
public class PigBossEntity extends EntityMob implements IBossDisplayData, IRangedAttackMob {
    ...
    public PigBossEntity(World world) {
        super(world);
    ...
    private void CallSoldiers(List var1, Entity var2) {
        ...
        for (int var3 = 0; var3 < var1.size(); ++var3) {
            ...
            if (var4 instanceof EntityPigZombie && ((EntityPigZombie) var4).getAITarget() == null) {
                ...
                (new PigmenSpeaker((FriendlyPigZombieEntity) null)).SendSpeech(EnumPigmenSpeaks.AnuSommon);
            }
        }
    }
