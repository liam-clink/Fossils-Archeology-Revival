...
public class MLightingEntity extends EntityLightningBolt {
    /**
    ...
    public MLightingEntity(World var1, double var2, double var4, double var6) {
    ...
    public void onUpdate() {
        ...
        if (this.lightningState >= 0) {
            ...
            for (int var4 = 0; var4 < var7.size(); ++var4) {
                ...
                if (!(var5 instanceof EntityPlayer) && !(var5 instanceof FriendlyPigZombieEntity) && !(var5 instanceof EntityPig)) {
