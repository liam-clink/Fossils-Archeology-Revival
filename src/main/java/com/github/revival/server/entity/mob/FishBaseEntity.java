...
public abstract class FishBaseEntity extends EntityWaterMob {
    ...
    public FishBaseEntity(World par1World) {
        super(par1World);
    ...
    public void HandleBreed() {
        ...
        if (this.BreedTick == 0) {
            ...
            for (int var4 = 0; var4 < var3.size(); ++var4) {
                if (var3.get(var4) instanceof FishBaseEntity) {
                    if (!var1) {
                        ++var2;
                        ...
                        //damage them
                        FishBaseEntity var5 = (FishBaseEntity) ((FishBaseEntity) var3.get(var4));
            ...
            if (!var1) {
                ...
                /*	FishBaseEntity var6 = null;

					if ((new Random()).nextInt(100) + 1 < var2)
					{
						var6 = new FishBaseEntity(this.worldObj);
