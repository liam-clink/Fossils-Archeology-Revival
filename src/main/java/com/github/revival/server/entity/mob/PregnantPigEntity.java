...
public class PregnantPigEntity implements IViviparous, IExtendedEntityProperties {
    ...
    public PregnantPigEntity(EntityPig pig) {
        this.pig = pig;
    ...
    public static final void register(EntityPig entity) {
        entity.registerExtendedProperties(PregnantPigEntity.PREGNANT_PIG_PROP, new PregnantPigEntity(entity));
    }

    //Return EntityPregnant* properties for Vanilla entity mobs.
    public static final PregnantPigEntity get(EntityPig entity) {
        return (PregnantPigEntity) entity.getExtendedProperties(PREGNANT_PIG_PROP);
    }
