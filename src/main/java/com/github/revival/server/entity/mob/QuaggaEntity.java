...
public class QuaggaEntity extends EntityAnimal implements IInvBasic {
    ...
    public QuaggaEntity(World par1World) {
        super(par1World);
        ...
        this.tasks.addTask(3, new EntityAIAvoidEntity(this, TerrorBirdEntity.class, 16.0F, 1D, 1.2D));
    ...
    public EntityAgeable createChild(EntityAgeable par1EntityAgeable) {
        QuaggaEntity quaggaEntity = (QuaggaEntity) par1EntityAgeable;
        QuaggaEntity babyQuagga = new QuaggaEntity(this.worldObj);
    ...
    public void showPedia2(PediaGui p0) {
        prehistoricEntityClass.ShowPedia2(p0, "Quagga");
    }
}
