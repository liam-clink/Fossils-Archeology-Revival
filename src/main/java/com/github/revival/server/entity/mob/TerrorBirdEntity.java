...
public class TerrorBirdEntity extends EntityTameable {
    ...
    public DinoAINearestAttackableTarget aiAttackNearestQuagga = new DinoAINearestAttackableTarget(this, QuaggaEntity.class, 40, true, true, false);
    ...
    PrehistoricEntity prehistoricEntityClass = new PrehistoricEntity(worldObj);
    private int rotationAngle;
    private int prevRotationAngle;
    private int nextTimeUntilNextEgg;


    public TerrorBirdEntity(World par1World) {
        super(par1World);
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (oclass != null && oclass.isAssignableFrom(this.getClass())) {
                    ...
                    if (entityageable != null) {
                        ((TerrorBirdEntity) entityageable).setSkin(this.getSkin());
     ...
     */
    public TerrorBirdEntity spawnBabyAnimal(EntityAgeable par1EntityAgeable) {
    ...
    public boolean canMateWith(EntityAnimal entityAnimal) {
        if (entityAnimal == this) {
            ...
            return false;
        } else if (!(entityAnimal instanceof TerrorBirdEntity)) {
            return false;
        } else {
            TerrorBirdEntity entity = (TerrorBirdEntity) entityAnimal;
    ...
    public void showPedia2(PediaGui p0) {
        prehistoricEntityClass.ShowPedia2(p0, this.names[this.getSkin()]);
    }
}
