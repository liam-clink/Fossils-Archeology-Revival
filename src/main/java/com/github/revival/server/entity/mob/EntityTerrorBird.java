...
public class EntityTerrorBird extends EntityTameable {
    ...
    public EntityTerrorBird(World par1World) {
        ...
        this.tasks.addTask(1, new EntityChildAIPanic(this, 1.4D)); // Only panic
        // if a
        // child.
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataWatcher.addObject(18, (byte) 0); // For skin
        this.dataWatcher.addObject(19, (byte) 0); // Bit used for
        // animations.
    ...
    public void onLivingUpdate() {
        ...
        if (!this.isChild() && !this.worldObj.isRemote && --this.timeUntilNextEgg <= 0) {
            ...
            // ItemStack(FAItemRegistry.INSTANCE.terrorBirdEgg, 1,
            // this.getSkin()), 1);
    ...
    public boolean attackEntityAsMob(Entity entity) {
        ...
        // this.playSound(Revival.MODID + ":" + "terror_bird_attack",
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (this.isTamed()) {
            ...
            // || (this.getSkin() != 0 && itemstack.getItem() ==
            // FAItemRegistry.INSTANCE.quaggaMeat))
            {
                if (!player.capabilities.isCreativeMode) {
                    --itemstack.stackSize;
                }
    ...
    public boolean canMateWith(EntityAnimal entityAnimal) {
        if (entityAnimal == this) {
            ...
            return this.getSkin() == entity.getSkin() && entity.isTamed() && (!entity.isSitting() && this.isInLove() && entity.isInLove());
        }
    }
    ...
    public void showPedia(GuiPedia p0) {
        ...
        // "textures/items/TerrorBird/" + "Egg_Cultivated_" +
        // names[this.getSkin()] + ".png"), ((p0.xGui / 2) + (p0.xGui / 4)), 7,
        // 16, 16);
