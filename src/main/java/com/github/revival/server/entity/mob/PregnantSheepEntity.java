...
public class PregnantSheepEntity implements IViviparous, IExtendedEntityProperties {
    ...
    public PregnantSheepEntity(EntitySheep sheep) {
        this.sheep = sheep;
    ...
    public static final void register(EntitySheep entity) {
        entity.registerExtendedProperties(PregnantSheepEntity.PREGNANT_SHEEP_PROP, new PregnantSheepEntity(entity));
    }

    //Return EntityPregnant* properties for Vanilla entity mobs.
    public static final PregnantSheepEntity get(EntitySheep entity) {
        return (PregnantSheepEntity) entity.getExtendedProperties(PREGNANT_SHEEP_PROP);
    }
