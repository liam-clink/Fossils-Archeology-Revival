...
public class DinoAIWaterAgressive extends EntityAIBase {
	...
	public boolean shouldExecute() {
		...
		return (this.entity.isInWater() && this.targetedEntity != null && this.targetedEntity.isInWater() && this.targetedEntity.getDistanceSqToEntity(this.entity) < distance * distance);
	}
	...
	public void updateTask() {
		...
		if (this.entity.isInWater() && this.targetedEntity != null && this.targetedEntity.isInWater() && this.targetedEntity.getDistanceSqToEntity(this.entity) < distance * distance) {
