...
public abstract class PrehistoricEntity extends EntityAgeable {
    ...
    public PrehistoricEntity(World world, EnumEntityPrehistoric type, int subSpecies, ModelBase model) {
        super(world);
        this.type = type;
     ...
     * @param feeder
     */
    public void eatFromFeeder(FeederTile feeder) {
    ...
    public void onKillEntity(EntityLivingBase entity) {
        if (entity instanceof PrehistoricEntity) {
            addHunger(((PrehistoricEntity) entity).getType().getHungerIfEaten());
            heal(((PrehistoricEntity) entity).getType().getHealthIfEaten());
        }
    }
     ...
     * @return
     */
    public double distanceToFeeder(FeederTile entity) {
     ...
     * @return
     */
    public int distanceStatus(FeederTile entity) {
     ...
     * @return
     */
    public boolean canFindFeeder(FeederTile entity) {
