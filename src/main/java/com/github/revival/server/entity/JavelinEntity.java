...
public class JavelinEntity extends EntityArrow implements IEntityAdditionalSpawnData {
    ...
    public JavelinEntity(World var1) {
        super(var1);
        this.SelfMaterial = ToolMaterial.WOOD;
    }

    public JavelinEntity(World var1, double var2, double var4, double var6) {
        super(var1, var2, var4, var6);
        this.SelfMaterial = ToolMaterial.WOOD;
    }

    public JavelinEntity(World var1, EntityPlayer var32, float var3, ToolMaterial var4, int damagevalue) {
    ...
    public JavelinEntity(World var1, EntityLiving var2, float var3) {
    ...
    protected boolean addJavelinToPlayer(EntityPlayer var1) {
        ...
        switch (this.SelfMaterial.ordinal())//JavelinEntity$1.$SwitchMap$net$minecraft$item$ToolMaterial[this.SelfMaterial.ordinal()])
        {
            case 0:
            default:
                var2 = new ItemStack(Revival.woodjavelin, 1);
                break;

            case 2:
                var2 = new ItemStack(Revival.ironjavelin, 1);
                break;

            case 3:
                var2 = new ItemStack(Revival.diamondjavelin, 1);
                break;

            case 1:
                var2 = new ItemStack(Revival.stonejavelin, 1);
                break;

            case 4:
                var2 = new ItemStack(Revival.goldjavelin, 1);
        }*/
