...
public enum EnumPrehistoric {
    ...
    Nautilus(EntityNautilus.class, EnumMobType.FISH, EnumTimePeriod.MESOZOIC,
	     EnumDiet.NONE, I.NOTHING, true, 0XC55F47, 0XF5F5F5),
    Coelacanth(
	       EntityCoelacanth.class, EnumMobType.FISH, EnumTimePeriod.MESOZOIC,
	       EnumDiet.NONE, I.NOTHING, true, 0X363941, 0X9BA1A9),
    Alligator_Gar(
		  EntityAlligatorGar.class, EnumMobType.FISH,
		  EnumTimePeriod.MESOZOIC, EnumDiet.NONE, I.NOTHING, true, 0X43462A,
		  0XAF4231),
    Sturgeon(EntitySturgeon.class, EnumMobType.FISH,
	     EnumTimePeriod.MESOZOIC, EnumDiet.NONE, I.NOTHING, true, 0X655D5B,
	     0XE6E3E3),
    Triceratops(EntityTriceratops.class,
		EnumMobType.DINOSAUR, EnumTimePeriod.MESOZOIC, EnumDiet.HERBIVORE,
		I.MODEL | I.TAME | I.RIDE | I.HERBIVORE, true, 0X64352D, 0X251A17,
		0.8F),
    Velociraptor(EntityVelociraptor.class, EnumMobType.DINOSAUR,
		 EnumTimePeriod.MESOZOIC, EnumDiet.CARNIVORE_EGG, I.TAME
			 | I.CARNIVORE, true, 0X4A0D04, 0XC9C9C9, 0.5F),
    Tyrannosaurus(
		  EntityTyrannosaurus.class, EnumMobType.DINOSAUR,
		  EnumTimePeriod.MESOZOIC, EnumDiet.CARNIVORE, I.MODEL | I.TAME
			  | I.RIDE | I.CARNIVORE, true, 0X9D8A74, 0X4C3116, 0.9F),
    Pterosaur(
	      EntityPterosaur.class, EnumMobType.DINOSAUR,
	      EnumTimePeriod.MESOZOIC, EnumDiet.PISCIVORE, I.MODEL | I.TAME
		      | I.CARNIVORE, true, 0XD6D6D6, 0X3B3B3B, 0.4F),
    Plesiosaur(
	       EntityPlesiosaurus.class, EnumMobType.DINOSAUR,
	       EnumTimePeriod.MESOZOIC, EnumDiet.PISCIVORE, I.MODEL | I.TAME
		       | I.RIDE | I.CARNIVORE, true, 0XE4A86E, 0XE17920),
    Mosasaurus(
	       EntityMosasaurus.class, EnumMobType.DINOSAUR,
	       EnumTimePeriod.MESOZOIC, EnumDiet.PISCCARNIVORE, I.MODEL
		       | I.CARNIVORE, true, 0X888D90, 0X3A4C52),
    Stegosaurus(
		EntityStegosaurus.class, EnumMobType.DINOSAUR,
		EnumTimePeriod.MESOZOIC, EnumDiet.HERBIVORE, I.MODEL | I.TAME
			| I.HERBIVORE, true, 0X9C8138, 0X651817, 0.7F),
    Dilophosaurus(
		  EntityDilophosaurus.class, EnumMobType.DINOSAUR,
		  EnumTimePeriod.MESOZOIC, EnumDiet.CARNIVORE, I.TAME | I.CARNIVORE,
		  true, 0X4E5931, 0XF25314, 0.5F),
    Brachiosaurus(
		  EntityBrachiosaurus.class, EnumMobType.DINOSAUR,
		  EnumTimePeriod.MESOZOIC, EnumDiet.HERBIVORE, I.MODEL | I.TAME
			  | I.RIDE | I.HERBIVORE, true, 0X52523E, 0X222114),
    Spinosaurus(
		EntitySpinosaurus.class, EnumMobType.DINOSAUR,
		EnumTimePeriod.MESOZOIC, EnumDiet.PISCCARNIVORE, I.MODEL
			| I.CARNIVORE, true, 0X84512A, 0X562F20, 0.8F),
    Compsognathus(
		  EntityCompsognathus.class, EnumMobType.DINOSAUR,
		  EnumTimePeriod.MESOZOIC, EnumDiet.CARNIVORE, I.MODEL | I.TAME
			  | I.CARNIVORE, true, 0XCBC7C4, 0X3A312C, 0.2F),
    Ankylosaurus(
		 EntityAnkylosaurus.class, EnumMobType.DINOSAUR,
		 EnumTimePeriod.MESOZOIC, EnumDiet.HERBIVORE, I.MODEL | I.TAME
			 | I.RIDE | I.HERBIVORE, true, 0X8A5B49, 0X211B13, 0.7F),
    Pachycephalosaurus(
		       EntityPachycephalosaurus.class, EnumMobType.DINOSAUR,
		       EnumTimePeriod.MESOZOIC, EnumDiet.HERBIVORE, I.TAME | I.HERBIVORE,
		       true, 0XB6A989, 0X7D5E3A, 0.6F),
    Deinonychus(
		EntityDeinonychus.class, EnumMobType.DINOSAUR,
		EnumTimePeriod.MESOZOIC, EnumDiet.CARNIVORE_EGG, I.MODEL | I.TAME
			| I.CARNIVORE, true, 0X2B2424, 0XC8C8C8, 0.6F),
    Gallimimus(
	       EntityGallimimus.class, EnumMobType.DINOSAUR,
	       EnumTimePeriod.MESOZOIC, EnumDiet.OMNIVORE, I.MODEL | I.TAME
		       | I.RIDE | I.HERB_CARN, true, 0X66412B, 0X5E2518, 0.5F),
    Liopleurodon(
		 EntityLiopleurodon.class, EnumMobType.DINOSAUR,
		 EnumTimePeriod.MESOZOIC, EnumDiet.PISCCARNIVORE, I.MODEL
			 | I.CARNIVORE, true, 0XBFC7C2, 0X1D211E),
    Allosaurus(
	       EntityAllosaurus.class, EnumMobType.DINOSAUR,
	       EnumTimePeriod.MESOZOIC, EnumDiet.CARNIVORE, I.MODEL | I.TAME
		       | I.RIDE | I.CARNIVORE, true, 0X907B6C, 0X5F422D, 0.8F),
    Sarcosuchus(
		EntitySarcosuchus.class, EnumMobType.DINOSAUR,
		EnumTimePeriod.MESOZOIC, EnumDiet.PISCCARNIVORE, I.TAME
			| I.CARNIVORE, true, 0X4B4929, 0X8D8C65, 0.7F),
    Ceratosaurus(
		 EntityCeratosaurus.class, EnumMobType.DINOSAUR,
		 EnumTimePeriod.MESOZOIC, EnumDiet.CARNIVORE, I.MODEL | I.TAME
			 | I.RIDE | I.CARNIVORE, true, 0XB4B4A7, 0X776446, 0.6F),
    Dryosaurus(
		 EntityDryosaurus.class, EnumMobType.DINOSAUR,
		 EnumTimePeriod.MESOZOIC, EnumDiet.HERBIVORE, I.MODEL | I.TAME | I.HERBIVORE, true, 0XB4B4A7, 0X776446, 0.6F),
    Confuciusornis(
    ...
    Dodo(EntityDodo.class, EnumMobType.BIRD,
	 ...
	 true, 0X655751, 0XBEA47B),
    Gastornis(EntityGastornis.class,
	      EnumMobType.BIRD, EnumTimePeriod.CENOZOIC, EnumDiet.HERBIVORE,
	      I.TAME, true, 0X346C5E, 0XC8C8C8),
    Kelenken(EntityKelenken.class,
	     EnumMobType.BIRD, EnumTimePeriod.CENOZOIC, EnumDiet.CARNIVORE,
	     I.TAME, true, 0X392F24, 0XF2EBD5),
    Phorusrhacos(
		 EntityPhorusrhacos.class, EnumMobType.BIRD,
		 EnumTimePeriod.CENOZOIC, EnumDiet.CARNIVORE, I.TAME, true,
		 0X5F4E3E, 0XD4D4D4),
    Titanis(EntityTitanis.class, EnumMobType.BIRD,
	    EnumTimePeriod.CENOZOIC, EnumDiet.CARNIVORE, I.TAME, true,
	    0X484848, 0XEFEFEF),
    Mammoth(EntityMammoth.class,
	    EnumMobType.MAMMAL, EnumTimePeriod.CENOZOIC, EnumDiet.HERBIVORE,
	    I.TAME | I.RIDE | I.HERBIVORE, true, 0X3D2E19, 0X24170B),
    Smilodon(
	     EntitySmilodon.class, EnumMobType.MAMMAL, EnumTimePeriod.CENOZOIC,
	     EnumDiet.CARNIVORE, I.TAME | I.CARNIVORE, true, 0XB88C64, 0XECDFCE),
    Quagga(
	   EntityQuagga.class, EnumMobType.MAMMAL, EnumTimePeriod.CENOZOIC,
	   EnumDiet.HERBIVORE, I.TAME | I.RIDE | I.HERBIVORE, true, 0X763C24,
	   0XD3B9AB),
    Elasmotherium(EntityElasmotherium.class,
		  EnumMobType.MAMMAL, EnumTimePeriod.CENOZOIC, EnumDiet.HERBIVORE,
		  I.TAME | I.RIDE | I.HERBIVORE, true, 0X6B321B, 0X666666),
    Pig(
	EntityPig.class, EnumMobType.VANILLA, EnumTimePeriod.CURRENT,
	EnumDiet.OMNIVORE, I.NOTHING, false, 0, 0),
    Cow(EntityCow.class,
	EnumMobType.VANILLA, EnumTimePeriod.CURRENT, EnumDiet.HERBIVORE,
	I.NOTHING, false, 0, 0),
    ...
    Chicken(EntityChicken.class,
	    EnumMobType.CHICKEN, EnumTimePeriod.CURRENT, EnumDiet.HERBIVORE,
	    I.NOTHING, false, 0, 0);
    ...
    EnumPrehistoric(Class class0, EnumMobType animalType,
	    EnumTimePeriod timeperiod, EnumDiet diet, int f0, boolean init,
	    int mainSpawnColor, int secondSpawnColor) {
    ...
    EnumPrehistoric(Class class0, EnumMobType animalType,
	    EnumTimePeriod timeperiod, EnumDiet diet, int f0, boolean init,
	    int mainSpawnColor, int secondSpawnColor, float eggScale) {
	this.dinoClass = class0;
	this.type = animalType;
	this.timeperiod = timeperiod;
	this.diet = diet;
	...
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    EnumPrehistoric.values()[i].DNAItem = new Item()
		    .setUnlocalizedName(
			    "dna" + EnumPrehistoric.values()[i].name())
		    .setTextureName(
			    "fossil:prehistoric/dna/"
				    + EnumPrehistoric.values()[i].name()
				    + "_DNA")
		    .setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
	    GameRegistry.registerItem(EnumPrehistoric.values()[i].DNAItem,
		    "dna" + EnumPrehistoric.values()[i].name());
	}
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    if (EnumPrehistoric.values()[i].type == EnumMobType.FISH) {
		EnumPrehistoric.values()[i].eggItem = new ItemFish(
			EnumPrehistoric.values()[i], true)
			.setUnlocalizedName(
				"egg" + EnumPrehistoric.values()[i].name())
			.setTextureName(
				"fossil:prehistoric/dinoEggs/"
					+ EnumPrehistoric.values()[i].name()
					+ "_Egg")
			.setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
		GameRegistry.registerItem(EnumPrehistoric.values()[i].eggItem,
			"egg" + EnumPrehistoric.values()[i].name());
	    }
	    if (EnumPrehistoric.values()[i].type == EnumMobType.DINOSAUR) {
		EnumPrehistoric.values()[i].eggItem = new DinoEggItem(
	...
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    if (EnumPrehistoric.values()[i].type == EnumMobType.MAMMAL
		    || EnumPrehistoric.values()[i].type == EnumMobType.VANILLA) {
		EnumPrehistoric.values()[i].embryoItem = new MammalEmbryoItem(i)
			.setUnlocalizedName(
				"embryo" + EnumPrehistoric.values()[i].name())
			.setTextureName(
				"fossil:prehistoric/embryos/"
					+ EnumPrehistoric.values()[i].name()
					+ "_Syringe")
			.setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
		GameRegistry.registerItem(
			EnumPrehistoric.values()[i].embryoItem, "embryo"
				+ EnumPrehistoric.values()[i].name());
	    }
	}
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    if (EnumPrehistoric.values()[i].type == EnumMobType.FISH) {
		EnumPrehistoric.values()[i].fishItem = new ItemFish(
			EnumPrehistoric.values()[i], false)
			.setUnlocalizedName(
				"fish" + EnumPrehistoric.values()[i].name())
			.setTextureName(
				"fossil:prehistoric/embryos/"
					+ EnumPrehistoric.values()[i].name()
					+ "_Syringe")
			.setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
		GameRegistry.registerItem(EnumPrehistoric.values()[i].fishItem,
			"fish" + EnumPrehistoric.values()[i].name());
	    }
	}
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    if (EnumPrehistoric.values()[i].type == EnumMobType.BIRD) {
		EnumPrehistoric.values()[i].birdEggItem = new BirdEggItem(
			EnumPrehistoric.values()[i], false)
			.setUnlocalizedName(
				"egg" + EnumPrehistoric.values()[i].name())
			.setTextureName(
				"fossil:prehistoric/birdEggs/Egg_"
					+ EnumPrehistoric.values()[i].name())
			.setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
		GameRegistry.registerItem(
			EnumPrehistoric.values()[i].birdEggItem, "egg"
				+ EnumPrehistoric.values()[i].name());
	    }
	}
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    if (EnumPrehistoric.values()[i].type == EnumMobType.BIRD
		    || EnumPrehistoric.values()[i].type == EnumMobType.CHICKEN) {
		EnumPrehistoric.values()[i].bestBirdEggItem = new BirdEggItem(
			EnumPrehistoric.values()[i], true)
			.setUnlocalizedName(
				"eggCultivated"
					+ EnumPrehistoric.values()[i].name())
			.setTextureName(
				"fossil:prehistoric/birdEggs/Egg_Cultivated_"
					+ EnumPrehistoric.values()[i].name())
			.setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
		GameRegistry.registerItem(
			EnumPrehistoric.values()[i].bestBirdEggItem,
			"eggCultivated" + EnumPrehistoric.values()[i].name());
	    }
	}
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    if (EnumPrehistoric.values()[i].timeperiod != EnumTimePeriod.CURRENT) {
		if (EnumPrehistoric.values()[i].type != EnumMobType.FISH) {
		    EnumPrehistoric.values()[i].foodItem = new ForgeFoodItem(3,
			    0.3F, true, "prehistoric/food/"
				    + EnumPrehistoric.values()[i].name()
				    + "_Meat").setUnlocalizedName(
			    "raw" + EnumPrehistoric.values()[i].name())
			    .setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
		    GameRegistry.registerItem(
			    EnumPrehistoric.values()[i].foodItem, "raw"
				    + EnumPrehistoric.values()[i].name());
		}
	    }
	}
	for (int i = 0; i < EnumPrehistoric.values().length; i++) {
	    if (EnumPrehistoric.values()[i].timeperiod != EnumTimePeriod.CURRENT
		    && EnumPrehistoric.values()[i] != Nautilus) {
		EnumPrehistoric.values()[i].cookedFoodItem = new ForgeFoodItem(
			8, 0.8F, true, "prehistoric/cookedFood/"
				+ EnumPrehistoric.values()[i].name() + "_Meat")
			.setUnlocalizedName(
				"cooked" + EnumPrehistoric.values()[i].name())
			.setCreativeTab(FATabRegistry.INSTANCE.tabFItems);
		GameRegistry.registerItem(
			EnumPrehistoric.values()[i].cookedFoodItem, "cooked"
				+ EnumPrehistoric.values()[i].name());
	    }
	}
    }
	...
	for (int i = 0; i < values().length; i++) {
	    if (values()[i].bestBirdEggItem == i0
		    || values()[i].birdEggItem == i0
		    || values()[i].embryoItem == i0
		    || values()[i].foodItem == i0 || values()[i].eggItem == i0) {
	...
	for (int i = 0; i < values().length; i++) {
	    if (values()[i].type == EnumMobType.BIRD
		    || values()[i].type == EnumMobType.CHICKEN) {
	...
	for (int i = 0; i < values().length; i++) {
	    if (values()[i].bestBirdEggItem == i0
		    || values()[i].birdEggItem == i0
		    || values()[i].embryoItem == i0
		    || values()[i].DNAItem == i0 || values()[i].eggItem == i0) {
	...
	for (int i = 0; i < values().length; i++) {
		...
		if (values()[i].birdEggItem == i0 || values()[i].DNAItem == i0
			|| values()[i].foodItem == i0) {
	...
	for (int i = 0; i < values().length; i++) {
	    if (values()[i].bestBirdEggItem == i0
		    || values()[i].embryoItem == i0
		    || values()[i].birdEggItem == i0
		    || values()[i].DNAItem == i0 || values()[i].foodItem == i0
		    || values()[i].eggItem == i0) {
		return i;
	    }
	}
	...
	for (int i = 0; i < values().length; i++) {
	    if (values()[i].type != EnumMobType.VANILLA
		    && values()[i].type != EnumMobType.CHICKEN
		    && values()[i].type != EnumMobType.FISH) {
		if (tar) {
		    if (values()[i].timeperiod == EnumTimePeriod.CENOZOIC
			    && EntityPrehistoric.class
				    .isAssignableFrom(values()[i].dinoClass)) {
			list.add(values()[i]);
		    }
		} else {
		    if (values()[i].timeperiod == EnumTimePeriod.MESOZOIC
			    || values()[i].timeperiod == EnumTimePeriod.PALEOZOIC) {
			list.add(values()[i]);
		    }
		}
	    }
	...
	if (Entity.class.isAssignableFrom(dinoClass)) {
	    try {
		entity = dinoClass.getDeclaredConstructor(World.class)
			.newInstance(world);
	...
	List<EnumPrehistoric> list = new ArrayList<EnumPrehistoric>();
	for (int i = 0; i < values().length; i++) {
	    if (values()[i].timeperiod != EnumTimePeriod.CURRENT
		    || values()[i].type != EnumMobType.FISH) {
		list.add(values()[i]);
	    }
	}
     ...
     * Hunger Value
     */
    private void setProperties(double H0, double HMax, double Str0,
	    double StrMax, double Sp0, double SpMax, int Hunger) {
	if (H0 > 0) {
	    this.Health0 = H0;
	}
