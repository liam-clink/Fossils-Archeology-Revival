...
public class BlockTar extends BlockFluidClassic {
    ...
    public BlockTar() {
        ...
        setUnlocalizedName(LocalizationStrings.TAR_NAME);
    ...
    public boolean canDisplace(IBlockAccess world, BlockPos pos) {
        return !world.getBlock(pos).getMaterial().isLiquid() && super.canDisplace(world, pos);
    }

    @Override
    public boolean displaceIfPossible(World world, BlockPos pos) {
        return !world.getBlock(pos).getMaterial().isLiquid() && super.displaceIfPossible(world, pos);
    }
    ...
    public void randomDisplayTick(World world, BlockPos pos, Random random) {
        ...
        if (random.nextInt(200) == 0) {
            world.playSound(pos, "fossil:tar", 0.1F + random.nextFloat() * 0.2F, 0.4F + random.nextFloat() * 0.15F, false);
        }
    }
