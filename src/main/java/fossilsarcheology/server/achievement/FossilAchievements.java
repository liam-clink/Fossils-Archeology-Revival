...
public class FossilAchievements {
    ...
    public static final Achievement FIND_ANU_TOTEM = new Achievement("achievement.findAnuTotem", "findAnuTotem", -6, 6, new ItemStack(FABlockRegistry.ANU_TOTEM), null).registerStat();
    ...
    public static final Achievement ANU_ATTACK = new Achievement("achievement.anuAttack", "anuAttack", 0, 5, new ItemStack(FAItemRegistry.ancientSword), ANUBITE_ENCOUNTER).registerStat();
    public static final Achievement ANU_DEAD = new Achievement("achievement.anuDead", "anuDead", 2, 5, new ItemStack(FAItemRegistry.brokenSword), ANU_ATTACK).registerStat().setSpecial();
    public static final Achievement ARC_WORKBENCH = new Achievement("achievement.arcWorkbench", "arcWorkbench", -6, 0, new ItemStack(FABlockRegistry.blockworktableActive), null).registerStat();
    public static final Achievement FIXED_SWORD = new Achievement("achievement.fixedSword", "fixedSword", -6, -2, new ItemStack(FAItemRegistry.ancientSword), ARC_WORKBENCH).registerStat();
    public static final Achievement FIXED_HELMET = new Achievement("achievement.fixedHelmet", "fixedHelmet", -6, 2, new ItemStack(FAItemRegistry.ancienthelmet), ARC_WORKBENCH).registerStat();
    public static final Achievement FIXED_VASE = new Achievement("achievement.fixedVase", "fixedVase", -4, 0, new ItemStack(FABlockRegistry.vaseAmphoraBlock, 1, 1), ARC_WORKBENCH).registerStat();
    ...
    public static final Achievement SCARAB_TOOLS = new Achievement("achievement.scarabTools", "scarabTools", 0, 4, new ItemStack(FAItemRegistry.gemSword), SCARAB).registerStat();
    ...
    public static final Achievement KEY = new Achievement("achievement.key", "key", 2, 7, new ItemStack(FAItemRegistry.ancientKey), ANU_DEAD).registerStat();
