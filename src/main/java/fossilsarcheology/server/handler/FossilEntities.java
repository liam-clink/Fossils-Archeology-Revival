...
public class FossilEntities {
    ...
    public static void registerEntities() {
        ...
        for (int i = 0; i < PrehistoricEntityType.values().length; i++) {
            if (PrehistoricEntityType.values()[i].mobType != MobType.CHICKEN && PrehistoricEntityType.values()[i].mobType != MobType.VANILLA)
                registerSpawnable(PrehistoricEntityType.values()[i].getEntity(), PrehistoricEntityType.values()[i].name(), 200 + i, PrehistoricEntityType.values()[i].primaryEggColor, PrehistoricEntityType.values()[i].secondaryEggColor);
        }
        ...
        SpawnListEntry alligatorgar = new SpawnListEntry(EntityAlligatorGar.class, 40, 1, 1);
