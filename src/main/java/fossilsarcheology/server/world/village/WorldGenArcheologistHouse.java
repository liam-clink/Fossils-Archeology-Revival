...
public class WorldGenArcheologistHouse extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        template.addBlocksToWorld(worldIn, position.up(3).offset(EnumFacing.NORTH, xSize).offset(EnumFacing.SOUTH, zSize), new FABlockProcessorVillage(position.up(3), settings, CHEST, component, biome), settings, 2);
