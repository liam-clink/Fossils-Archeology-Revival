...
public class EntityJavelin extends EntityArrow implements IEntityAdditionalSpawnData {
    ...
    protected boolean addJavelinToPlayer(EntityPlayer var1) {
		 ...
		 * ItemStack var2;
		 * 
		 * switch (this.SelfMaterial.ordinal())//EntityJavelin$1.
		 * $SwitchMap$net$minecraft$item$ToolMaterial
		 * [this.SelfMaterial.ordinal()]) { case 0: default: var2 = new
		 * ItemStack(Revival.woodjavelin, 1); break;
		 * 
		 * case 2: var2 = new ItemStack(Revival.ironjavelin, 1); break;
		 * 
		 * case 3: var2 = new ItemStack(Revival.diamondjavelin, 1); break;
		 * 
		 * case 1: var2 = new ItemStack(Revival.stonejavelin, 1); break;
		 * 
		 * case 4: var2 = new ItemStack(Revival.goldjavelin, 1); }
		 */
