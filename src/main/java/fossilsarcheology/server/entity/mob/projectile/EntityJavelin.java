...
public class EntityJavelin extends EntityArrow implements IEntityAdditionalSpawnData {
    ...
    public EntityJavelin(World world, EntityPlayer player, float var3, ToolMaterial material, int damaged) {
        super(world, player, var3);
        this.material = material;
        this.damaged = damaged;
    }

    public EntityJavelin(World world, EntityLiving var2, float var3) {
        super(world, var2, var3);
        this.material = ToolMaterial.WOOD;
    }
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            vec31 = new Vec3d(this.posX + this.motionX / 2, this.posY + this.motionY / 2, this.posZ + this.motionZ / 2);
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    i1 += this.material.getDamageVsEntity();
    ...
    protected boolean addJavelinToPlayer(EntityPlayer var1) {
        ItemStack var2 = new ItemStack(getJavelinFromMaterial(), 1);
    ...
    private Item getJavelinFromMaterial() {
        switch (this.material.ordinal()) {
            case 0:
            default:
    ...
    public void writeSpawnData(ByteArrayDataOutput var1) {
        var1.writeInt(this.material.ordinal());
    }

    public void readSpawnData(ByteArrayDataInput var1) {
        this.material = ToolMaterial.values()[var1.readInt()];
    }
