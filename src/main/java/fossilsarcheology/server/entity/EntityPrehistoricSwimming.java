...
public abstract class EntityPrehistoricSwimming extends EntityPrehistoric {
    ...
    public boolean isDirectPathBetweenPoints(Vec3d vec1, Vec3d vec2) {
        MovingObjectPosition movingobjectposition = this.worldObj.func_147447_a(vec1, new Vec3d(vec2.xCoord, vec2.yCoord + (double) this.height * 0.5D, vec2.zCoord), false, true, false);
