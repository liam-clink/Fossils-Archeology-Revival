...
public class LivingCoelacanthItem extends Item {
    ...
    public LivingCoelacanthItem(int DinoType0) {
        super();
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < icons.length; i++) {
            // icons[i] = par1IconRegister.registerIcon(Revival.MODID + ":" +
        ...
        // this.itemIcon = par1IconRegister.registerIcon("fossil:" +
        // "Coelacanth_live_Ocean");
    }
    ...
    public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
        ...
        if (var23 == null) {
            ...
            for (Object aVar27 : var27) {
                Entity var29 = (Entity) aVar27;
