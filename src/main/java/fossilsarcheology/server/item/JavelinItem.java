...
public class JavelinItem extends Item {
     ...
     */
    /*
	 * public int getIconFromDamage(int var1) { return this.SelfMaterial ==
	 * ToolMaterial.GOLD ? 52 : (this.SelfMaterial == ToolMaterial.EMERALD ? 51
	 * : (this.isAncient ? 64 : this.SelfMaterial.getHarvestLevel() + 48)); }
	 */
	...
	/*
	 * public boolean isAncient() { return this.isAncient; }
	 * 
	 * public Item setAncient(boolean var1) { this.isAncient = var1; return
	 * this; }
	 */
}