...
public class GuiSifter extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (this.sifterInventory.isBurning()) {
            ...
            // this.drawTexturedModalRect(centerX + 70, centerY + 44 -
            // siftTimeRemaining, 176, 12 - siftTimeRemaining, 14,
            // siftTimeRemaining + 2);
            // this.drawTexturedModalRect(centerX + 75, centerY + 33, 181, 2,
            // 31, 31);
        }

        siftTimeRemaining = this.sifterInventory.getSiftProgressScaled(26);
        // this.drawTexturedModalRect(centerX + 79, centerY + 34, 176, 14,
