...
public class RenderStoneboard extends Render {
    ...
    private void func_160_a(EntityStoneboard var1, float var2, float var3) {
		 ...
		 * 
		 * if (var1.direction == 2) { var4 = MathHelper.floor_double(var1.posX +
		 * (double)(var2 / 16.0F)); }
		 * 
		 * if (var1.direction == 1) { var6 = MathHelper.floor_double(var1.posZ -
		 * (double)(var2 / 16.0F)); }
		 * 
		 * if (var1.direction == 0) { var4 = MathHelper.floor_double(var1.posX -
		 * (double)(var2 / 16.0F)); }
		 * 
