...
public class RenderPlayerCapes {
	 ...
	 * isDeveloper(e.entityPlayer.getUniqueID())){ e.setCanceled(true); }
	 * 
	 ...
	 * this.interpolateRotation(e.entityPlayer.prevRotationYawHead,
	 * e.entityPlayer.rotationYawHead, unknown); float f4;
	 * 
	 * if (e.entityPlayer.isRiding() && e.entityPlayer.ridingEntity instanceof
	 * EntityLivingBase) { EntityLivingBase entitylivingbase1 =
	 * (EntityLivingBase)e.entityPlayer.ridingEntity; f2 =
	 * this.interpolateRotation(entitylivingbase1.prevRenderYawOffset,
	 * entitylivingbase1.renderYawOffset, unknown); f4 =
	 ...
	 * f2 = f3 - f4;
	 * 
	 * if (f4 * f4 > 2500.0F) { f2 += f4 * 0.2F; } float f13 =
	 * e.entityPlayer.prevRotationPitch + (e.entityPlayer.rotationPitch -
