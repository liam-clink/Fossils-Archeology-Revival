...
public class FliesParicle extends Particle {
    ...
    private static TextureManager textureManager = Minecraft.getMinecraft().getTextureManager(); // get
    // the
    // TextureManager
    // instance
    ...
    public FliesParicle(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14) {
