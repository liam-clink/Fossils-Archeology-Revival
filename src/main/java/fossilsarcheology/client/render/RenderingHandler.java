...
public class RenderingHandler {
    ...
    public void onInit() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityPteranodon.class, new RenderPrehistoric(new ModelPteranodon()));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityEdaphosaurus.class, new RenderPrehistoric(new ModelEdaphosaurus()));
