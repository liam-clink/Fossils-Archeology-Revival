...
public class ModelSifter extends ModelBase {
     ...
     * setRotationAngles(f, f1, f2, f3, f4, f5, entity); longwall1.render(f5);
     * shortwall2.render(f5); longwall2.render(f5); shortwall1.render(f5);
     * top.render(f5); floor.render(f5); sifter.render(f5); }
     *
