...
public class ClientProxy extends ServerProxy {
    ...
    public static void registerModels(ModelRegistryEvent event) {
        ...
        ModelLoader.setCustomStateMapper(FABlockRegistry.SIGILLARIA_LEAVES, (new StateMap.Builder()).ignore(BlockLeaves.CHECK_DECAY, BlockLeaves.DECAYABLE).build());
        ModelLoader.setCustomStateMapper(FABlockRegistry.SIGILLARIA_FENCE_GATE, (new StateMap.Builder()).ignore(FossilFenceGateBlock.POWERED).build());
        ModelLoader.setCustomStateMapper(FABlockRegistry.SIGILLARIA_DOOR, (new StateMap.Builder()).ignore(FossilDoorBlock.POWERED).build());
