...
public class WorldGenPalaeoraphe extends WorldGenerator
{
    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        ...
        var1.setBlock(var3 - 3, var4 + 14, var5 + 3, Fossil.palmLeaves);
        var1.setBlock(var3 - 3, var4 + 14, var5 - 3, Fossil.palmLeaves);
        /*var1.setBlockAndMetadata(var3 + 6, var4 + 14, var5, Fossil.palmLeaves, 0);
        var1.setBlockAndMetadata(var3, var4 + 13, var5 + 6, Fossil.palmLeaves, 0);
        var1.setBlockAndMetadata(var3 - 6, var4 + 13, var5, Fossil.palmLeaves, 0);
        var1.setBlockAndMetadata(var3, var4 + 13, var5 - 6, Fossil.palmLeaves, 0);*/
        return true;
    }
}
