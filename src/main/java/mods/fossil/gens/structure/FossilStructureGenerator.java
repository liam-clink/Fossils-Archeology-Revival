		...
		case AcademyUtil.CUSTOM_CHEST:
			...
			if (customData1 == AcademyUtil.COMMON_LOOT_F1) {
				...
				for (int iterate = 0; iterate < rand.nextInt(12); iterate++) {
					...
					if (loot < 30) {
						...
						addItemToTileInventory(world, new ItemStack(
								Fossil.biofossil, rand.nextInt(22)), x, y, z);
					} else if (loot < 85) {
						addItemToTileInventory(world, new ItemStack(
								Fossil.woodjavelin, rand.nextInt(16)), x, y, z);
					} else if (loot < 95) {
						addItemToTileInventory(world, new ItemStack(
								Fossil.stonejavelin, rand.nextInt(16)), x, y, z);
					} else if (loot < 101) {
						addItemToTileInventory(world, new ItemStack(
								Fossil.drum, 1), x, y, z);
					}
			...
			if (customData1 == AcademyUtil.RARE_LOOT_F2) {
				for (int iterate = 0; iterate < rand.nextInt(1) + 3; iterate++) {
					...
					if (i < 3)
						addItemToTileInventory(world, new ItemStack(
								Fossil.dinoPedia, rand.nextInt(1) + 1), x, y, z);
					else if (i < 7)
						addItemToTileInventory(world, new ItemStack(
								Fossil.relic, rand.nextInt(9) + 1), x, y, z);
					else {
						addItemToTileInventory(world, new ItemStack(
								Fossil.potteryShards, rand.nextInt(9) + 1), x,
								y, z);
					}
				}
			}
			...
			if (customData1 == AcademyUtil.RARE_LOOT_F3) {
				...
				for (int iterate = 0; iterate < rand.nextInt(4); iterate++) {
					...
					if (loot < 20) {
						addItemToTileInventory(world, new ItemStack(
								Fossil.ancientGlass, rand.nextInt(10)), x, y, z);
					} else if (loot < 40) {
						addItemToTileInventory(world, new ItemStack(
								Fossil.ancientWood, rand.nextInt(15)), x, y, z);
					} else if (loot < 50) {
						addItemToTileInventory(world, new ItemStack(
								Fossil.whip, 1), x, y, z);
					} else if (loot < 60) {
						...
						addItemToTileInventory(world, new ItemStack(
								Fossil.fossilrecordBones, 1), x, y, z);
					} else if (loot < 101) {
						addItemToTileInventory(world, new ItemStack(
			...
			if (customData1 == AcademyUtil.TEMPLE_COMMON_LOOT) {
				...
				for (int iterate = 0; iterate < rand.nextInt(4); iterate++) {
					...
					if (loot < 40) {
						...
						addItemToTileInventory(world, new ItemStack(
								Fossil.goldjavelin, rand.nextInt(10) + 1), x,
								y, z);
					} else if (loot < 60) {
						addItemToTileInventory(
								world,
			...
			if (customData1 == AcademyUtil.TEMPLE_RARE_LOOT) {
				...
				if (loot < 90) {
					addItemToTileInventory(world, new ItemStack(
							Fossil.goldjavelin, rand.nextInt(11) + 1), x, y, z);
					addItemToTileInventory(world, new ItemStack(Items.emerald,
							rand.nextInt(5)), x, y, z);

				} else {
					addItemToTileInventory(world, new ItemStack(
							Fossil.goldjavelin, rand.nextInt(10) + 3), x, y, z);
					addItemToTileInventory(world, new ItemStack(
							Fossil.diamondjavelin, rand.nextInt(10) + 1), x, y,
							z);
					addItemToTileInventory(world, new ItemStack(Fossil.relic,
							rand.nextInt(20)), x, y, z);
					addItemToTileInventory(world, new ItemStack(
							Fossil.skullStick, rand.nextInt(1)), x, y, z);
					addItemToTileInventory(world, new ItemStack(Items.emerald,
		...
		case TempleUtil.CUSTOM_RELIC:
			if (world.rand.nextFloat() < 0.25F) // spawn items
			{
				if (world.rand.nextFloat() < 0.5F) // spawn vanes
				{
					...
					world.setBlock(x, y, z, Fossil.vaseKylixBlock,
							randomVaseType, 2);
				...
				} else // spawn figurines
				{
					...
					world.setBlock(x, y, z, Fossil.figurineBlock, randomMeta2,
							2);
