...
public class WorldGenTarPit extends WorldGenerator
{
    ...
    public WorldGenTarPit(Block block)
    {
        blockIndex = block;
    }
        ...
        for (int k1 = 0; k1 < 16; k1++)
        {
            for (int i2 = 0; i2 < 16; i2++)
            {
                for (int k2 = 0; k2 < 8; k2++)
                {
                    ...
                    Material material = world.getBlock(x + k1, y + k2, z + i2).getMaterial();
                    ...
                    if (k2 < 4 && !material.isSolid() && world.getBlock(x + k1, y + k2, z + i2) != blockIndex)
                    {
                        return false;
                    }
                }
        ...
        for (int l1 = 0; l1 < 16; l1++)
        {
            for (int j2 = 0; j2 < 16; j2++)
            {
                for (int l2 = 0; l2 < 8; l2++)
                {
                    ...
                    {
                        world.setBlock(x + l1, y + l2, z + j2, (l2 >= 4 ? Blocks.air : blockIndex));
                    }
                }
            }
        }
