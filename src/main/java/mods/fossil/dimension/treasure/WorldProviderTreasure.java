package mods.fossil.dimension.treasure;
...
public class WorldProviderTreasure extends WorldProvider{
	...
	public void registerWorldChunkManager(){
		this.worldChunkMgr = new WorldChunkManagerHell(Fossil.treasureBiome, 0);
		this.dimensionId = Fossil.dimensionID_treasure;
		this.hasNoSky = true;
	...
	{
		return DimensionManager.createProviderFor(Fossil.dimensionID_treasure);
	}
