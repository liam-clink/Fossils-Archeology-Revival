package mods.fossil.dimension.anu;
...
public class WorldProviderAnu extends WorldProvider{
	...
	public void registerWorldChunkManager(){
		this.worldChunkMgr = new WorldChunkManagerHell(Fossil.anuBiome, 0);
		this.dimensionId = Fossil.dimensionID_anu;
		this.hasNoSky = true;
	...
	{
		return DimensionManager.createProviderFor(Fossil.dimensionID_anu);
	}
