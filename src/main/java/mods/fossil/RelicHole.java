...
public class RelicHole {
	...
	public RelicHole(Random var1, int var2, int var3, int var4, byte[] var5,
			int var6) {
		do {
			this.CordX = var1.nextInt(var2);
			this.CordY = var1.nextInt(var3);
			this.CordZ = var1.nextInt(var4);
			this.MixedIndex = this.CordY * var2 * var4 + this.CordZ * var2
					+ this.CordX;
	...
	public boolean isHole(int var1, int var2, int var3) {
		int var4 = (int) Math.sqrt(Math.pow((double) (this.CordX - var1), 2.0D)
				+ Math.pow((double) (this.CordY - var2), 2.0D)
				+ Math.pow((double) (this.CordZ - var3), 2.0D));
