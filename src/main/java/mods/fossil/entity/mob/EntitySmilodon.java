...
public class EntitySmilodon extends EntityPrehistoric
{
    ...
    {
        return Fossil.modid + ":" + "smilodon_living";
    }
    ...
    {
        return Fossil.modid + ":" + "smilodon_hurt";
    }
    @Override
    /**
    ...
    {
        return Fossil.modid + ":" + "smilodon_death";
    }
    ...
    {
        return this.isChild() ? item == Items.milk_bucket : item == Items.beef || item == Items.porkchop || item == Items.chicken;// || var1 == Fossil.rawDinoMeat.itemID;
    }

    private boolean TamedInterest(Item item)
    {
        return !this.isTamed() ? this.isInterest(item) : item == Items.beef || item == Items.porkchop || item == Items.chicken;// || var1 == Fossil.rawDinoMeat.itemID;
    }
