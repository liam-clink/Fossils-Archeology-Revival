 ...
 */
package mods.fossil.entity.mob.test;

import java.util.List;

import mods.fossil.entity.mob.EntityDinosaur;
import mods.fossil.fossilAI.test.DragonFlightWaypoint;
 ...
 */
public abstract class EntityFlyingDinosaur extends EntityDinosaur {
    private static final int IN_AIR_THRESH = 10;
    
    public static final BaseAttribute MOVE_SPEED_AIR = new RangedAttribute("generic.movementSpeedAir", 1.5, 0.0, Double.MAX_VALUE).setDescription("Movement Speed Air").setShouldWatch(true);
    
    // data value IDs
    private static final int INDEX_FLYING = 25;
    private static final int INDEX_CAN_FLY = 26;
    ...
    public EntityFlyingDinosaur(World world, EnumDinoType dinotype) {
    ...
    protected void applyEntityAttributes() {
        ...
        getAttributeMap().getAttributeInstance(MOVE_SPEED_AIR);
    }
