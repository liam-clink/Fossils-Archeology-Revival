...
public class EntityTerrorBird extends EntityTameable
{
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (this.isBurning())
        {
            this.dropItem(Fossil.terrorBirdMeatCooked, 1);
        }
        else
        {
            this.dropItem(Fossil.terrorBirdMeat, 1);
        }
    }
    ...
    public boolean attackEntityAsMob(Entity entity)
    {
        ...
        //this.playSound(Fossil.modid + ":" + "terror_bird_attack", this.getSoundVolume(), this.getSoundPitch());
        return flag;
    }
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        else if (itemstack != null)
        {
	        	if((this.getSkin() == 0 && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin))
	        			|| (this.getSkin() != 0 && itemstack.getItem() == Fossil.quaggaMeat))
	        	{
		            if (!player.capabilities.isCreativeMode)
		            {
		                --itemstack.stackSize;
