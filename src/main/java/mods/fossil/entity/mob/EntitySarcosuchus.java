...
public class EntitySarcosuchus extends EntityDinosaur {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(EnumDinoType.Sarcosuchus.Speed0);
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(EnumDinoType.Sarcosuchus.Health0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(EnumDinoType.Sarcosuchus.Strength0);
    }
    ...
    /*
     * Called for when a player interacts with a dinosaur
     * Specificly for now when a player tames the dinosaur.
     */
