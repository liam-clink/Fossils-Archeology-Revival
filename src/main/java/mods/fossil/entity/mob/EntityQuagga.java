...
public class EntityQuagga extends EntityAnimal implements IInvBasic
{
    ...
    public void openGUI(EntityPlayer player)
    {
        if (!this.worldObj.isRemote && (this.riddenByEntity == null || this.riddenByEntity == player) && this.isTame())
        {
            ...
            player.openGui(Fossil.instance, 8, worldObj, this.getEntityId(), 0, 0);
            }
        }
    }
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        else if (itemstack != null && FMLCommonHandler.instance().getSide().isClient() && itemstack.getItem() == Fossil.dinoPedia)
        {
            this.setPedia();
