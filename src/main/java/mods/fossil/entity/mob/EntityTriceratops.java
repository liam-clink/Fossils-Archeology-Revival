...
public class EntityTriceratops extends EntityDinosaur
{
	...
	public EntityTriceratops(World var1)
	{
		...
		if(FossilOptions.TriceratopsQuills){
			texturePath = Fossil.modid + ":textures/mob/" + this.SelfType.toString() + "/quilled/";
		}else{
	...
	private boolean FindFren(int var1)
	{
		...
		for (var6 = -var1; var6 <= var1; ++var6)
		{
			for (var7 = -2; var7 <= 2; ++var7)
			{
				...
				{
					if (this.worldObj.getBlock((int)Math.round(this.posX + (double)var6), (int)Math.round(this.posY + (double)var7), (int)Math.round(this.posZ + (double)var8)) == Fossil.ferns && var2 > this.GetDistanceWithXYZ(this.posX + (double)var6, this.posY + (double)var7, this.posZ + (double)var8))
					{
		...
		else
		{
			...
			for (var6 = -1; var6 <= 1; ++var6)
			{
				...
				{
					if (this.worldObj.getBlock((int)Math.round(this.posX + (double)var3 + (double)var6), (int)Math.round(this.posY + (double)var4), (int)Math.round(this.posZ + (double)var5 + (double)var7)) == Fossil.ferns)
					{
						...
						if (this.worldObj.getBlock((int)Math.round(this.posX + (double)var3 + (double)var6), (int)Math.round(this.posY + (double)var4) + 1, (int)Math.round(this.posZ + (double)var5 + (double)var7)) == Fossil.ferns)//fernUpper
						{
