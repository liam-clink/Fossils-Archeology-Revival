...
public class BlockAnuPortal extends Block {
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && (par5Entity instanceof EntityPlayerMP))
		{
			...
			else if (thePlayer.dimension != Fossil.dimensionID_anu)
			{
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Fossil.dimensionID_anu, new AnuTeleporter(thePlayer.mcServer.worldServerForDimension(Fossil.dimensionID_anu)));
			}
			else
			{
				thePlayer.timeUntilPortal = 10;
