...
import mods.fossil.guiBlocks.ContainerCultivateWeak;
...
public class GuiCultivateWeak extends GuiContainer
{
    private static final ResourceLocation loc = new ResourceLocation("fossil:textures/gui/Cultivate.png");
    private TileEntityCultivateWeak cultivateInventory;

    public GuiCultivateWeak(InventoryPlayer var1, TileEntity var2)
    {
        super(new ContainerCultivateWeak(var1, var2));
        this.cultivateInventory = (TileEntityCultivateWeak)var2;
    }
