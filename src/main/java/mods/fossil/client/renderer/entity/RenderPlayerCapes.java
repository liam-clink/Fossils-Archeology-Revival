...
public class RenderPlayerCapes {
	 ...
	 */
	public ModelDilophosaurus model_Alexthe666 = new ModelDilophosaurus();
	...
	public ModelNautilus model_NanoTyrano = new ModelNautilus();
	...
	public void playerRender(RenderPlayerEvent.Pre e) {
		...
		if (e.entityPlayer instanceof AbstractClientPlayer) {
			...
			if(e.entityPlayer.getUniqueID().equals(alexID)){
				...
				model_Alexthe666.renderFollower(0.625F);
				GL11.glPopMatrix();
				GL11.glPopMatrix();
			...
			if(e.entityPlayer.getUniqueID().equals(raptorID)){
				...
				GL11.glTranslatef(0, -30F, 0);
				GL11.glPushMatrix();
				FMLClientHandler.instance().getClient().getTextureManager().bindTexture(new ResourceLocation("fossil:textures/mob/Deinonychus/feathered/Feathered_Deinonychus_Black_Adult.png"));
