...
{
    public RenderGallimimus(ModelBase par1ModelBase, float par2)
    {
     ...
     */
    protected void preRenderScale(EntityGallimimus entitydinosaur, float par2)
    {
    ...
    {
        this.preRenderScale((EntityGallimimus)par1EntityLivingBase, par2);
    }

    protected ResourceLocation func_110919_a(EntityGallimimus par1Entity)
    {
    ...
    {
        return this.func_110919_a((EntityGallimimus)par1Entity);
    }
}