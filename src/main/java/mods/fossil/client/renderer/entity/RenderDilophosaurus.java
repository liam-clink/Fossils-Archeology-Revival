...
{
    public RenderDilophosaurus(ModelBase par1ModelBase, float par2)
    {
     ...
     */
    protected void preRenderScale(EntityDilophosaurus entitydinosaur, float par2)
    {
    ...
    {
        this.preRenderScale((EntityDilophosaurus)par1EntityLivingBase, par2);
    }
