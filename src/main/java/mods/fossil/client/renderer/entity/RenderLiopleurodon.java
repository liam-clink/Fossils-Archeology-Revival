...
{
    public RenderLiopleurodon(ModelBase par1ModelBase, float par2)
    {
     ...
     */
    protected void preRenderScale(EntityLiopleurodon entitydinosaur, float par2)
    {
    ...
    {
        this.preRenderScale((EntityLiopleurodon)par1EntityLivingBase, par2);
    }

    protected ResourceLocation func_110919_a(EntityLiopleurodon par1Entity)
    {
    ...
    {
        return this.func_110919_a((EntityLiopleurodon)par1Entity);
    }
}