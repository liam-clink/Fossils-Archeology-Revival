...
public class TileEntityCultivateStrongRenderer extends TileEntitySpecialRenderer {
	public static final ResourceLocation textureStrong = new ResourceLocation("fossil:textures/blocks/cultureVat/culturevat_yellow.png");
	...
	public TileEntityCultivateStrongRenderer(){
	...
	public void renderCultureVatAt(TileEntityCultivateStrong tileentity, double x, double y, double z, float f) {
		...
		if(tileentity.getDNAType() == 1){
			...
			GL11.glPushMatrix();
			this.bindTexture(textureStrong);
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		this.renderCultureVatAt((TileEntityCultivateStrong)tileentity, x, y, z, f);
	}
}
