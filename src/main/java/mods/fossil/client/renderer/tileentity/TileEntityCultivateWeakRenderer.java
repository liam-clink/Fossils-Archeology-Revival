...
public class TileEntityCultivateWeakRenderer extends TileEntitySpecialRenderer {
	public static final ResourceLocation textureWeak = new ResourceLocation("fossil:textures/blocks/cultureVat/culturevat_red.png");
	...
	public TileEntityCultivateWeakRenderer(){
	...
	public void renderCultureVatAt(TileEntityCultivateWeak tileentity, double x, double y, double z, float f) {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		this.renderCultureVatAt((TileEntityCultivateWeak)tileentity, x, y, z, f);
	}
}
