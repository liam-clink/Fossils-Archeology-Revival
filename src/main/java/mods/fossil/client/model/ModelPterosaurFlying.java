...
public class ModelPterosaurFlying extends ModelPterosaurGround
{
	...
	protected void setRotationAngles(float f, float f1, float f2, float f3,
		...
		if(modelized) return;
		Left_wing_1.rotateAngleZ=-1.570796F;
		Left_wing_2.rotateAngleZ=1.570796F;
		Right_wing_1.rotateAngleZ=1.570796F;
		Right_wing_2.rotateAngleZ=-1.570796F;
	...
	public float LeftWingRandomFlap=0.5F;
	public float RightWingRandomFlap=0.5F;
