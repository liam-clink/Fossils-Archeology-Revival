...
/**
 * Ceratosaurus.tcn - TechneToTabulaImporter
...
public class ModelCeratosaurus extends ModelDinosaurs {
    ...
    public ModelCeratosaurus() {
        ...
        this.lowerBody.addBox(-5.0F, -1.0F, 0.0F, 10, 10, 10, 0.0F);
        ...
        this.leftFoot.setRotationPoint(-0.5F, 8.3F, 0.5F);
        ...
        this.upperBody = new ModelRenderer(this, 21, 20);
        this.upperBody.setRotationPoint(0.0F, 3.0F, 4.0F);
        this.upperBody.addBox(-4.0F, -4.0F, -12.0F, 8, 9, 12, 0.0F);
        ...
        this.rightFoot.setRotationPoint(0.5F, 8.3F, 0.5F);
        ...
        this.leftThigh.setRotationPoint(4.0F, 8.5F, 8.5F);
        ...
        this.rightThigh.setRotationPoint(-4.5F, 8.5F, 8.5F);
        ...
        this.rightLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 9, 3, 0.0F);
        ...
        this.setRotateAngle(lowerJaw, -1.5501637768927253E-17F, -0.0F, 0.0F);
        ...
        this.setRotateAngle(rightHorn, 0.6304129258203518F, -0.239459173373622F, -0.4242895411598215F);
        ...
        this.leftLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 9, 3, 0.0F);
        ...
        this.setRotateAngle(headPivot, 0.3839724354387525F, -0.0F, 0.0F);
        ...
        this.leftUpperArm.setRotationPoint(4.0F, 3.0F, -10.2F);
        ...
        this.rightUpperArm.setRotationPoint(-4.0F, 3.0F, -10.2F);
