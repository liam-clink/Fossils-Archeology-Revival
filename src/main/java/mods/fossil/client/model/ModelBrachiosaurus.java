...
public class ModelBrachiosaurus extends ModelDinosaurs {
	float yoffset = 0.0F;
	ModelRenderer Snout = (new ModelRenderer(this, 50, 8)).setTextureSize(64,
			32);
	ModelRenderer Head;
	ModelRenderer Crest;
	ModelRenderer Neck;
	...
	public ModelBrachiosaurus() {
		...
		// Legs
		Front_ThighRight = (new ModelRenderer(this, 50, 21)).setTextureSize(64,
				32);
		...
		Front_CalfRight = (new ModelRenderer(this, 0, 24)).setTextureSize(64,
				32);
		...
		Front_ThighLeft = (new ModelRenderer(this, 50, 21)).setTextureSize(64,
				32);
		...
		Front_CalfLeft = (new ModelRenderer(this, 0, 24))
		...
		Back_ThighRight = (new ModelRenderer(this, 50, 21)).setTextureSize(64,
				32);
		...
		Back_CalfRight = (new ModelRenderer(this, 0, 24))
				.setTextureSize(64, 32);
		...
		Back_ThighLeft = (new ModelRenderer(this, 50, 21)).setTextureSize(64,
				32);
	 ...
	 */
	public void render(Entity var1, float var2, float var3, float var4,
			float var5, float var6, float var7) {
		float var14 = 0.0225F;
		super.render(var1, var2, var3, var4, var5, var6, var7);
		this.setRotationAngles(var2, var3, var4, var5, var6, var7,
				((EntityDinosaur) var1).isModelized());
	...
	private void setRotation(ModelRenderer var1, float var2, float var3,
			float var4) {
	...
	protected void setRotationAngles(float var1, float var2, float var3,
		...
		if (!isModelized) {
			...
			this.Front_ThighLeft.rotateAngleX = MathHelper
					.cos((var1) * 0.63330555F + 1) * 1.0F * var2;
			this.Front_ThighRight.rotateAngleX = MathHelper.cos((var1)
					* 0.63330555F + (float) Math.PI)
					* 1.0F * var2;
			this.Back_ThighLeft.rotateAngleX = MathHelper.cos((var1)
					* 0.63330555F + (float) Math.PI + 2)
					* 1.0F * var2;
			this.Back_ThighRight.rotateAngleX = MathHelper
					.cos((var1) * 0.63330555F + 1) * 1.0F * var2;
			this.Tail.rotateAngleY = 0.05F * MathHelper.sin(var3 * (float) 0.1F
					+ (var2 + 2));
			this.Tail1.rotateAngleY = 0.06F * MathHelper.sin(var3
					* (float) 0.1F + (var2 + 1));
			this.Tail2.rotateAngleY = 0.07F * MathHelper.sin(var3
					* (float) 0.1F + (var2));
		} else {
