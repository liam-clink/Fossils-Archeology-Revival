...
public class TileEntitySifter extends TileEntity implements IInventory, ISidedInventory
{
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            if (this.sifterItemStacks[this.RawIndex].getItem() == Item.getItemFromBlock(Blocks.sand)
            	|| this.sifterItemStacks[this.RawIndex].getItem() == Item.getItemFromBlock(Blocks.dirt)
        		|| this.sifterItemStacks[this.RawIndex].getItem() == Item.getItemFromBlock(Blocks.gravel)
        		|| this.sifterItemStacks[this.RawIndex].getItem() == Item.getItemFromBlock(Blocks.clay)
        		|| this.sifterItemStacks[this.RawIndex].getItem() == Item.getItemFromBlock(Fossil.volcanicAsh)
