...
public class TileEntityFeeder extends TileEntity implements IInventory, ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.feederItemStacks[0] != null && this.MeatCurrent < this.MeatMax && EnumDinoFoodItem.foodtype(this.feederItemStacks[0].getItem()) == EnumDinoFoodItem.ISCARNIVOROUS) //the carnivore part
            {
                //there is an item in, its carn. food and there is space
                int val = EnumDinoFoodItem.getItemFood(this.feederItemStacks[0].getItem());
            ...
            if (this.feederItemStacks[1] != null && this.VegCurrent < this.VegMax && (EnumDinoFoodItem.foodtype(this.feederItemStacks[1].getItem()) == EnumDinoFoodItem.ISHERBIVOROUS || EnumDinoFoodBlock.getBlockFood(this.feederItemStacks[1].getItem()) > 0)) //herbivore part
            {
                int val = EnumDinoFoodItem.getItemFood(this.feederItemStacks[1].getItem()) + EnumDinoFoodBlock.getBlockFood(this.feederItemStacks[1].getItem());
 ...
 //   			|| EnumDinoFoodItem.foodtype(itemstack.itemID) == EnumDinoFoodItem.ISHERBIVOROUS) : true);
		if(par1 == 1 & EnumDinoFoodItem.foodtype(itemstack.getItem()) == EnumDinoFoodItem.ISHERBIVOROUS)
				return true;
		
		if (par1 == 0 && EnumDinoFoodItem.foodtype(itemstack.getItem()) == EnumDinoFoodItem.ISCARNIVOROUS)
				return true;
