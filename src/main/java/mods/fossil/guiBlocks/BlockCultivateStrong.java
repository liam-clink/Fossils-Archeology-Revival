...
public class BlockCultivateStrong extends BlockContainer {
	...
	public BlockCultivateStrong(boolean isActive) {
	...
	public Item getItemDropped(int par1, Random rand, int par2) {
		...
		return Item.getItemFromBlock(Fossil.blockStrongcultivateIdle);
	...
	public boolean onBlockActivated(World var1, int var2, int var3, int var4,
		...
		if (var1.isRemote) {
			...
			var5.openGui(Fossil.instance, 10, var1, var2, var3, var4);
			return true;
		}
	}
	...
	public static void updateFurnaceBlockState(boolean isActive, World world,
		...
		if (isActive) {
				...
				world.setBlock(x, y, z, Fossil.blockStrongcultivateActive);
			
		} else {
			
				world.setBlock(x, y, z, Fossil.blockStrongcultivateIdle);
	...
	public TileEntity createNewTileEntity(World world, int par2) {
		...
		return new TileEntityCultivateStrong();
	}
	...
	private void ReturnDNA(World world, int x, int y, int z) {
		if (!keepFurnaceInventory) {
			TileEntityCultivateStrong tileentity = (TileEntityCultivateStrong) world
					.getTileEntity(x, y, z);
			if(tileentity != null){
	...
	public void onBlockRemovalLost(World world, int x, int y, int z,
		...
		if (isActive) {
			TileEntityCultivateStrong tileentity = (TileEntityCultivateStrong) world.getTileEntity(x, y, z);
			if(tileentity != null){
	...
	public Item getItem(World world, int x, int y, int z) {
		...
		return Item.getItemFromBlock(Fossil.blockStrongcultivateActive);
	}
}
