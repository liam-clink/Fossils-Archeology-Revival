...
public class TileEntityCultivateWeak extends TileEntity implements IInventory, ISidedInventory {
	...
	public TileEntityCultivateWeak() {
	}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (var1 != this.furnaceCookTime > 0) {
				var2 = true;
				BlockCultivateWeak.updateFurnaceBlockState(
		...
		if (var2) {
			...
			if (this.furnaceCookTime == 1501 && (new Random()).nextInt(100) < 50) {
				((BlockCultivateWeak) Fossil.blockWeakcultivateIdle).onBlockRemovalLost(this.worldObj, this.xCoord, this.yCoord, this.zCoord, true);
			}		
