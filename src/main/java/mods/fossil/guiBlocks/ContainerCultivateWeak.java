...
public class ContainerCultivateWeak extends Container {
	private TileEntityCultivateWeak furnace;
	...
	public ContainerCultivateWeak(InventoryPlayer var1, TileEntity var2) {
		this.furnace = (TileEntityCultivateWeak) var2;
