...
public class TileEntityCultivateStrong extends TileEntity implements IInventory,
ISidedInventory {
	...
	public TileEntityCultivateStrong() {
	}
	...
	public void readFromNBT(NBTTagCompound var1) {
		...
		for (int var3 = 0; var3 < var2.tagCount(); ++var3) {
			...
			if (var5 >= 0 && var5 < this.cultivateItemStacks.length) {
				this.cultivateItemStacks[var5] = ItemStack
	...
	public int getCookProgressScaled(int var1) {
		return this.furnaceCookTime * var1 / 9000;
	}

	public int getBurnTimeRemainingScaled(int var1) {
		if (this.currentItemBurnTime == 0) {
			this.currentItemBurnTime = 9000;
		}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (var1 != this.furnaceCookTime > 0) {
				var2 = true;
				BlockCultivateStrong.updateFurnaceBlockState(
		...
		if (var2) {
			...
			if (this.furnaceCookTime == 4501 && (new Random()).nextInt(100) < 5) {
				((BlockCultivateStrong) Fossil.blockStrongcultivateIdle).onBlockRemovalLost(this.worldObj, this.xCoord, this.yCoord, this.zCoord, true);
			}		
	}
	...
	public String getInvName() {
		return this.isInvNameLocalized() ? this.customName : "tile."
				+ LocalizationStrings.BLOCK_CULTIVATE_IDLE_NAME + ".name";
	}
