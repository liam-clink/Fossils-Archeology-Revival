...
public class ContainerCultivateStrong extends Container {
	private TileEntityCultivateStrong furnace;
	...
	public ContainerCultivateStrong(InventoryPlayer var1, TileEntity var2) {
		this.furnace = (TileEntityCultivateStrong) var2;
