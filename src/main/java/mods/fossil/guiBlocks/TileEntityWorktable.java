...
public class TileEntityWorktable extends TileEntity implements IInventory,
	 ...
	 * Fossil.brokenSword ? new ItemStack(Fossil.ancientSword) : (var1 ==
	 * Fossil.brokenhelmet ? new ItemStack(Fossil.ancienthelmet) : (var1 ==
	 * Fossil.gemAxe ? new ItemStack(Fossil.gemAxe) : (var1 == Fossil.gemPickaxe
	 * ? new ItemStack(Fossil.gemPickaxe) : (var1 == Fossil.gemSword ? new
	 * ItemStack(Fossil.gemSword) : (var1 == Fossil.gemHoe ? new
	 * ItemStack(Fossil.gemHoe) : (var1 == Fossil.gemShovel ? new
	 * ItemStack(Fossil.gemShovel) : null)))))); }
	 */
	...
	private ItemStack CheckSmelt(ItemStack itemstack) {
		...
		if (itemstack.getItem() == new ItemStack(Fossil.vaseKylixBlock)
				.getItem() && itemstack.getItemDamage() == 0) {
			output = new ItemStack(Fossil.vaseKylixBlock, 1, 1);
			return output;
		}

		if (itemstack.getItem() == new ItemStack(Fossil.vaseAmphoraBlock)
				.getItem() && itemstack.getItemDamage() == 0) {
			output = new ItemStack(Fossil.vaseAmphoraBlock, 1, 1);
			return output;
		}

		if (itemstack.getItem() == new ItemStack(Fossil.vaseVoluteBlock)
				.getItem() && itemstack.getItemDamage() == 0) {
